  ...
  howtointerrupt: [
    {
      ...
      inputs: [
        ...
        { q: "Nobody else is interrupting.", a: "Watch again. The ones you think aren't are just doing it smoothly.", bundle: 'pro' },
        { q: "If it mattered they'd have asked me.", a: "They can't ask for something they don't know you have.", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "There's no polite way in, so I'll wait.", a: "\"Can I jump in—\" is the polite way in. Two words and you're through.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "Everyone else clearly followed that.", a: "Half of them didn't. You'd be doing four people a favour.", bundle: 'pro' },
        { q: "Asking would show I wasn't keeping up.", a: "It shows you were following closely enough to notice where it broke.", bundle: 'pro' },
        { q: "It's probably answered later in the deck.", a: "Then they'll say so in four words. That's a cheap outcome.", bundle: 'pro' },
        { q: "I'll catch up afterwards on my own.", a: "You'll spend twenty minutes on what ten seconds would have fixed.", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "I've spoken more than anyone and I can feel it.", a: "Good — you noticed. Hand the next one over by name.", bundle: 'pro' },
        ...
        { q: "Someone keeps starting and getting cut off.", a: "Then use your next turn on them. \"I think Sam was going to say something.\"", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "They'll think I stopped listening ages ago.", a: "Name their last point before yours. That's the proof, and it takes four words.", bundle: 'pro' },
        { q: "I can't summarise what they said, which is the problem.", a: "Then you weren't listening. Wait for the next point and catch that one.", bundle: 'pro' },
        ...
        { q: "My point contradicts theirs, so acknowledging feels false.", a: "You're acknowledging that they said it, not that they're right.", bundle: 'pro' },
        ...
        { q: "It sounds like a technique when I do it.", a: "Only if you use a formula. Use their own words and it just sounds like listening.", bundle: 'pro' },
  ...
  handleinterruptions: [
    {
      ...
      inputs: [
        ...
        { q: "It happens to me more than to other people.", a: "Possibly. Notice whether you trail off at the ends — that's an invitation.", bundle: 'pro' },
        { q: "I went blank the second they started talking.", a: "Write the last three words down if you can. The thread comes back with them.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "If I let this one go I've lost the point.", a: "You've delayed it. Reclaiming later costs less than fighting for it now.", bundle: 'pro' },
        { q: "Giving way once means giving way always.", a: "Choosing is not giving way. It's the difference between yielding and being rolled over.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "A joke makes the whole thing sound trivial.", a: "It makes the interruption trivial. What you say next is as serious as you like.", bundle: 'pro' },
        { q: "I'm not quick enough to be funny under pressure.", a: "You don't need funny. \"I'll take that as enthusiasm\" is enough.", bundle: 'pro' },
        { q: "They'll think I'm not bothered when I am.", a: "Bothered is what you show if the joke has an edge. Say it warm and finish the point.", bundle: 'pro' },
        { q: "It lets them off for interrupting.", a: "It lets the room off. They still hear that it happened.", bundle: 'pro' },
        { q: "If I joke I'll have to keep it light afterwards.", a: "No. One light line and then straight back to the sentence you were on.", bundle: 'pro' },
        ...
        { q: "It feels like a trick to avoid saying the real thing.", a: "Then say the real thing after it. The joke buys you the room to.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "Offering them a turn hands over the floor.", a: "It hands over the next one. You've just kept this one.", bundle: 'pro' },
        ...
        { q: "I might forget to come back to them.", a: "Then you've broken it once and they'll push harder. Say the name and remember it.", bundle: 'pro' },
        ...
        { q: "I invited them in and they had nothing.", a: "Fine. That's the interruption revealed for what it was, at no cost to you.", bundle: 'pro' },
      ]
    },
  ],
  validation: [
  ...
  describethings: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "I might as well give everything and let them pick.", a: "They can't pick. They don't know which one identifies it — you do.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "I've owned it for years, I know it perfectly.", a: "Familiarity is what stops you seeing it. Look like a stranger for two seconds.", bundle: 'pro' },
        { q: "The room's too dark to check properly.", a: "Then say what you're sure of and mark the rest as uncertain.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "I should check before I describe it.", a: "If it's to hand, check. If it isn't, approximate and say you're approximating.", bundle: 'pro' },
  ...
  storytellingwiththesixws: [
    {
      ...
      inputs: [
        ...
        { q: "The people who are good at this are just born with it.", a: "They're using six questions on repeat. You can see them if you listen for them.", bundle: 'pro' },
        { q: "I told one last week and it died halfway.", a: "Then something was missing. Ask which of the six, not whether you can do it.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "I need to explain the background first.", a: "You need to say what happened first. Background is what you add when they ask.", bundle: 'pro' },
        { q: "I've started and I've already lost the shape.", a: "Ask yourself which of the six is missing. Usually it's Why.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "I'm halfway through and it's dragging.", a: "Jump to the event. You can fill in behind it if anyone asks.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "There are three things they need to know first.", a: "Then there are three things they'll ask. Let them, and answer as you go.", bundle: 'pro' },
  ...
  agreeing: [
    {
      ...
      inputs: [
        ...
        { q: "I'd rather say nothing than just say yes.", a: "Then say yes and one thing. That's not just saying yes.", bundle: 'pro' },
        { q: "Disagreeing shows I've thought about it.", a: "So does agreeing with a reason. The reason is where the thinking shows.", bundle: 'pro' },
        { q: "I've agreed three times in a row now.", a: "If it's true three times, say it three times. Manufactured objections are worse.", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "I found my example early and stopped listening.", a: "Then you'll agree with the topic, not with them. Go back to their last sentence.", bundle: 'pro' },
        ...
        { q: "If I wait I'll lose the thread of my point.", a: "You'll lose a worse version of it. The one that fits arrives later.", bundle: 'pro' },
        { q: "They finished and I said mine straight away.", a: "Fast is fine. Just make sure it answers what they ended on.", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "My example has no point to it.", a: "It doesn't need one. It needs to be true and to fit what they said.", bundle: 'pro' },
        { q: "Someone already told a better version.", a: "Then yours confirms it from another angle. That's worth more than a better story.", bundle: 'pro' },
        { q: "It's just something that happens to everyone.", a: "That's why it lands. Recognition is the thing you're after.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "I can add something that tops what they said.", a: "Then you've turned an agreement into a competition. Add beside, not above.", bundle: 'pro' },
  ...
  setupquestion: [
    {
      ...
      inputs: [
        ...
        { q: "Asking first means they set the subject.", a: "They set the first subject. You set the second, with your own answer.", bundle: 'pro' },
        { q: "I asked and they gave me almost nothing.", a: "Then answer it yourself anyway. Your answer is the second question.", bundle: 'pro' },
        { q: "It feels like I'm interviewing them.", a: "An interview is questions with no answers. Give yours and it stops being one.", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "Talking about myself right after feels like hijacking it.", a: "It's the other half of what you asked. Without it they've been interviewed.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "The obvious question is what everyone asks them.", a: "And everyone stops at the answer. Asking the second one is where you differ.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "This person and I have nothing left to ask each other.", a: "You've used one type on repeat. Switch the type, not the person.", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "\"How are you\" is just something people say.", a: "It is, until you stop walking. Then it's a question, and they hear that.", bundle: 'pro' },
        ...
        { q: "I don't want to open something I can't close.", a: "You can close it. \"Glad it's not just me — right, back to it.\"", bundle: 'pro' },
        { q: "It's a lazy question.", a: "It's the one that works on a day when nothing else does. That isn't laziness.", bundle: 'pro' },
        { q: "I asked and they gave me the whole thing.", a: "Then it worked. Listen, say your own version, and let it end naturally.", bundle: 'pro' },
        ...
        { q: "I should ask something more interesting.", a: "More interesting to you. Ask this one and answer it yourself, and it's plenty.", bundle: 'pro' },
      ]
    },
  ],
