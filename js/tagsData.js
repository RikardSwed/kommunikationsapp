...
const packTags = {
  ...
  alexandergrace4: [
    'speaking up', 'resentment', 'impact', 'requests', 'hints', 'privacy', 'relationships', 'friends'
  ],
  alexandergrace5: [
    'criticism', 'apology', 'accountability', 'defensiveness', 'shame', 'repair', 'relationships', 'tone'
  ],
  alexandergrace6: [
    'opening up', 'vulnerability', 'appreciation', 'support', 'sharing', 'affection', 'relationships', 'closeness'
  ],
  alexandergrace7: [
    'timing', 'attention', 'turn-taking', 'ground rules', 'misunderstanding', 'intent', 'relationships', 'emotional conversations'
  ],
  alexandergrace8: [
    'honesty', 'reassurance', 'compliments', 'disagreement', 'expectations', 'fairness', 'patterns', 'relationships'
  ],
  praxfield1: [
    'praxeology', 'field reports', 'beta patterns', 'rian stone', 'agency', 'covert contracts'
  ],
  praxfield2: [
    'praxeology', 'field reports', 'relational storms', 'rian stone', 'disengagement', 'emotional distance'
  ],
  praxfield3: [
    'praxeology', 'field reports', 'sexual polarity', 'rian stone', 'aaa anchors', 'desire'
  ],
  praxfield4: [
    'praxeology', 'field reports', 'power talk', 'pac model', 'subtext', 'rian stone'
  ],
};
