...
// Conversation Foundations, Part 2
    ...
    praxfield1: { label: 'Praxeology Field Reports 01 – Deconstructing Beta Patterns', minLevel: 'complete' },
...
const WHATS_NEW = [
  ...
  { version: 'v1.29.19', date: 'September 2026', title: 'Praxeology Field Reports 01–04, built from source with NotebookLM', audience: 'dev', items: ['Four new complete packs in Communication in Relationships, built by NotebookLM from Praxeology Volume 3: Deconstructing Beta Patterns, Navigating Relational Storms, Restoring Sexual Polarity and Advanced Subtext & Power-Talk.', 'Content is NotebookLM\'s own; only syntax, pack names, TOPICS, typos and two factual slips in Memorize were fixed.', 'Packs 03 and 04 carry concept decks (AAA Anchors; PAC Model and Power-Talk). In pack 03, 26 silent back sides got a spoken line, written by NotebookLM on request.'] },
