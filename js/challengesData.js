...
const challengesCollections = {
  ...
  reactingtounexpectedstatements: [
    {
      ...
      inputs: [
        ...
        { q: "It needs saying properly and this is not the moment.", a: "\"I want to come back to that. Not here, though.\" [Park It]", guideBack: "A promise to continue", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You want to make sure the conversation continues.", a: "\"Can I check in with you next week? Not to fix anything.\" [Park It]", guideBack: "A promise to continue", bundle: 'pro' },
        { q: "They tell you and then immediately change the subject.", a: "\"We can leave it — but I heard it, and I'd like to come back to it.\" [Park It]", guideBack: "A promise to continue", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "It is worth discussing but not here and not now.", a: "\"I'd like to come back to that properly sometime.\" [Park It]", guideBack: "A promise to continue", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You dismissed something and have changed your mind.", a: "\"Can I come back to yesterday? I answered too fast.\" [Park It]", guideBack: "A promise to continue", bundle: 'pro' },
        ...
        { q: "You agreed too readily and now regret it.", a: "\"I said yes too fast yesterday. Can we go back to it?\" [Park It]", guideBack: "A promise to continue", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "Something lands in a meeting and everyone looks at you.", a: "\"I'd want to think about that before I answer.\" [Park It]", guideBack: "A promise to continue", bundle: 'pro' },
        ...
        { q: "Someone puts you on the spot about a decision.", a: "\"I'll answer that properly by the end of the day.\" [Park It]", guideBack: "A promise to continue", bundle: 'pro' },
        { q: "They say something about you in front of the team.", a: "\"That's worth talking about. Can we do it after?\" [Park It]", guideBack: "A promise to continue", bundle: 'pro' },
  ...
  describethings: [
    ...
    },
    {
      ...
      inputs: [
        { q: "They have never seen the object at all.", a: "\"Think of a garlic press, but bigger and for potatoes.\" [What It Is Like]", guideBack: "A known thing, one change", bundle: 'pro' },
        { q: "They ask what a food tastes like.", a: "\"Somewhere between a pear and an apple, but softer than both.\" [What It Is Like]", guideBack: "A known thing, one change", bundle: 'pro' },
        { q: "They cannot picture the place.", a: "\"Imagine a train station, but the roof is glass and it's full of market stalls.\" [What It Is Like]", guideBack: "A known thing, one change", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "They have never met the person and you need them to spot her.", a: "\"A bit like Sara from the shop — same height, same glasses.\" [What It Is Like]", guideBack: "A known thing, one change", bundle: 'pro' },
  ...
  setupquestion: [
    {
      ...
      inputs: [
        ...
        { q: "You realise they know nothing about you.", a: "\"You've had all the questions. I came straight from work and I'm still winding down.\" [Background Question]", guideBack: "Their run-up, then yours", bundle: 'pro' },
        { q: "You have asked a fourth question without giving anything back.", a: "\"Right — my turn to be useful. I've been here twice and I still don't know where the coffee is.\" [Status Question]", guideBack: "Their honest answer, then yours", bundle: 'pro' },
        { q: "You catch yourself planning the next question mid-answer.", a: "\"Say that last bit again. I stopped listening and started planning, which is rude of me.\" [Status Question]", guideBack: "Their honest answer, then yours", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You asked how they were and got \"fine, thanks\" and a pause.", a: "\"I'll go first, then — I'm shattered and mildly grumpy. How's your week actually been?\" [Status Question]", guideBack: "Their honest answer, then yours", bundle: 'pro' },
        { q: "The real question got the ritual answer.", a: "\"Fair enough. I'm running on four hours' sleep, which explains most things about me today.\" [Status Question]", guideBack: "Their honest answer, then yours", bundle: 'pro' },
        ...
        { q: "They gave the polite version and moved straight on.", a: "\"Mine's less polite — this week has been a mess. What's yours actually been like?\" [Status Question]", guideBack: "Their honest answer, then yours", bundle: 'pro' },
        { q: "You want to reopen it without asking the same thing twice.", a: "\"I won't ask again. I'll just say I'm knackered and see whether that's contagious.\" [Status Question]", guideBack: "Their honest answer, then yours", bundle: 'pro' },
        ...
        { q: "You asked something personal too early.", a: "\"Too nosy, sorry. Safer ground — how did you hear about this?\" [Background Question]", guideBack: "Their run-up, then yours", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "The question was too wide and they went blank.", a: "\"Let me narrow that. Been anywhere at all this summer? I got as far as my mother's.\" [Background Question]", guideBack: "Their run-up, then yours", bundle: 'pro' },
        ...
        { q: "The blank is because they have only just arrived.", a: "\"You've only just walked in. How did you get here — far to come?\" [Background Question]", guideBack: "Their run-up, then yours", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "The question landed in the middle of a group and died.", a: "\"Let me aim that better. Sara, how do you know everyone here?\" [Background Question]", guideBack: "Their run-up, then yours", bundle: 'pro' },
        ...
        { q: "The group is split into two conversations and you are in neither.", a: "\"What have I missed on that side? I've been stuck on parking talk.\" [Status Question]", guideBack: "Their honest answer, then yours", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "The exchange worked and then stopped dead.", a: "\"You said Gothenburg. Is that where you're from, or just where you were?\" [Background Question]", guideBack: "Their run-up, then yours", bundle: 'pro' },
        ...
        { q: "They mentioned something in passing that you skipped over.", a: "\"You said 'again' — have you done this one before?\" [Background Question]", guideBack: "Their run-up, then yours", bundle: 'pro' },
  ...
  givingcounterexamples: [
    {
      ...
      inputs: [
        ...
        { q: "You want the exception to sound like curiosity rather than correction.", a: "\"Where do you think it stops working? I keep hitting the same edge.\" [Ask for Theirs]", guideBack: "A question that hands them the search", bundle: 'pro' },
      ]
    },
    {
  ...
  startingconversations2: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You start to give advice about their life rather than the situation.", a: "\"None of my business, though. How's it going otherwise?\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
        ...
        { q: "They took the tip and clearly want the conversation over.", a: "\"Good to see you anyway. I'll let you get on.\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You know something was going on but not what.", a: "\"You told me something last time and I've completely lost it. What was happening?\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
        { q: "You remember the topic but not the outcome.", a: "\"Did the house thing ever get sorted? I've lost track of where you got to.\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
        { q: "You are about to guess and might guess wrong.", a: "\"Refresh me — was it the interview or the move that was happening?\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
        ...
        { q: "You realise mid-sentence you have mixed them up with someone else.", a: "\"That's someone else entirely, isn't it. Sorry. What have you been up to?\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
        ...
        { q: "You remember the detail but not whether they told you or someone else.", a: "\"Someone told me about the allotment and I think it was you. Was it?\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
        { q: "The last conversation was months ago and could have gone anywhere.", a: "\"It's been ages. What's changed since?\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "Someone was waiting on medical results.", a: "\"How have you been? You had things going on last time we spoke.\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
        { q: "You know they were at risk of losing a job.", a: "\"How did things land at work in the end? Only if you want to.\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
        { q: "They gave a very short answer and you were going to ask more.", a: "\"Fair enough. Are you around for the rest of the week?\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
        ...
        { q: "They said it did not go well and you do not know what to say.", a: "\"That's rough. Do you want to talk about it or would you rather not?\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
        { q: "You want to open the door without pushing it.", a: "\"How are things? Say 'fine' if that's easier.\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "They clearly do not want to talk about it.", a: "\"Say no more. Are you off after this?\" [The Shared Thread]", guideBack: "A question about something they mentioned", bundle: 'pro' },
  ...
  showunderstanding: [
    {
      ...
      inputs: [
        ...
        { q: "They describe a problem you have solved before.", a: "\"That sounds genuinely exhausting to keep managing.\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        ...
        { q: "You gave advice, it was ignored, and they are back with the same thing.", a: "\"So it's still going, and nothing's shifted it.\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
      ]
    },
    {
      ...
      guideFront: "Choose a strategy when...",
      guideBack: "One way it could sound",
      description: "You relate to what they said, and four sentences later the conversation is about you, and nobody is quite sure how it happened.\n\n**What goes wrong:** your version grows a middle. Two sentences and a question is the whole move; anything with a middle and an ending is a story, and stories take the floor whether or not you meant them to.\n\n**What works here:** **Relate Through Sharing**, kept to two sentences. When it has already gone too far, **Loop Back** is the way back — saying their point in your own words puts them back in the middle of it.\n\n**Avoid:** the second example. One matching experience is relating; two is a turn.\n\nMindset: relating is a nod, not a turn. If your version has a middle, cut the middle.",
      inputs: [
        { q: "You are three sentences into your own version.", a: "\"Anyway \u2014 so it was the deadline moving that did it, not the work itself?\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        { q: "You notice they have started asking you questions.", a: "\"We've ended up on me. So the group thing \u2014 nobody told you until the Friday?\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        ...
        { q: "Someone else joins and asks you about the thing you just mentioned.", a: "\"Later \u2014 she was saying the group project landed on her with two days left.\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        ...
        { q: "They politely wait for your story to finish.", a: "\"That's enough from me. So the whole thing came out of one email?\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "You can hear yourself using a therapist voice.", a: "\"Right, so it's the being left out that's the actual problem.\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You have lost the order of what happened.", a: "\"Let me check I've got it — the plan changed twice and you found out last?\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        ...
        { q: "You are about to loop back something you are not sure of.", a: "\"Tell me if this is wrong — it's the not being asked that's the issue?\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        ...
        { q: "You followed all of it except the ending.", a: "\"So it's resolved — or it isn't, and that's the problem?\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
    ...
    },
    {
      ...
      guideFront: "Choose a strategy when...",
      guideBack: "One way it could sound",
      description: "They have given you three words and a shrug, and there is almost nothing to reflect or ask about.\n\n**What goes wrong:** you ask a bigger question, and a bigger question is harder to answer than a small one. Open questions about feelings are the hardest of all for somebody who has already decided not to go into it.\n\n**What works here:** **Loop Back** what you can see rather than what they said — it gives them something to agree with or correct, which is far easier than producing an answer. **Relate Through Sharing** works as a way of going first, so they do not have to.\n\n**Avoid:** pushing. Offering a word and leaving the door open is the whole move; whether they walk through it is theirs to decide.\n\nMindset: you are not trying to get it out of them. You are letting them know the offer is there.",
      inputs: [
        { q: "They say: \"It's fine, honestly.\" and clearly mean the opposite.", a: "\"It sounds less fine and more relentless, from where I'm sitting.\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        { q: "They shrug and change the subject.", a: "\"Fair enough. I'm around if it turns into something you want to say.\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        { q: "They say: \"I don't really want to go into it.\"", a: "\"That's completely fine. No need.\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        ...
        { q: "Their face says a lot more than their three words did.", a: "\"You don't have to say anything. It just looks like a lot.\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        { q: "They give one-word answers to everything you ask.", a: "\"I'll stop asking. It's just good to see you.\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
  ...
  exploringatopic: [
    {
      ...
      guideFront: "Choose a strategy when...",
      guideBack: "One way it could sound",
      description: "Everyone has said their piece and the subject is out of air. The next thing is either silence or an abrupt jump to something unrelated.\n\n**What goes wrong:** you wait to be sure. By the time the pause has landed, whatever you say has to restart the whole conversation rather than continue it.\n\n**What works here:** **Build on Their Point** squeezes one more layer out of the thread, and **Expand to a Subtopic** steps sideways once there genuinely is nothing left.\n\n**Avoid:** a brand-new subject. The group was enjoying this one, and a jump throws away everything already established.\n\nMindset: spot the fade early. A thread ending is not the topic ending.",
      inputs: [
        { q: "The group has covered everything about their holidays.", a: "\"Does anyone actually enjoy the travelling part, or just the arriving?\" [Expand to a Subtopic]", guideBack: "A neighbouring subject, not a new one", bundle: 'pro' },
        { q: "The conversation about the album has nothing left in it.", a: "\"Are they any good live? I have never seen them.\" [Expand to a Subtopic]", guideBack: "A neighbouring subject, not a new one", bundle: 'pro' },
        ...
        { q: "The talk about running has covered routes, shoes and races.", a: "\"Does anyone do anything else — swimming, cycling?\" [Expand to a Subtopic]", guideBack: "A neighbouring subject, not a new one", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "The music conversation drifted into phone contracts.", a: "\"That reminds me — does anyone still buy actual records?\" [Expand to a Subtopic]", guideBack: "A neighbouring subject, not a new one", bundle: 'pro' },
  ...
  changingtopics: [
    {
      ...
      inputs: [
        ...
        { q: "A story you've already heard is being retold in full.", a: "\"Still a great one — so, tell me something I haven't heard yet.\" [Respectful Exit]", guideBack: "One way it could sound", bundle: 'pro' },
        { q: "They keep returning to a work gripe you've discussed from every angle.", a: "\"We've squeezed that dry, I think. Shall we move to something new?\" [Respectful Exit]", guideBack: "One way it could sound", bundle: 'pro' },
        ...
        { q: "They circle back to it every time you open something else.", a: "\"You clearly need to say more about it. Say it properly, then let's leave it.\" [Respectful Exit]", guideBack: "One way it could sound", bundle: 'pro' },
        { q: "The loop is a happy one — a story they love telling.", a: "\"I love that one. What's the newest thing you've got?\" [Respectful Exit]", guideBack: "One way it could sound", bundle: 'pro' },
        { q: "A group has gone round the same subject three times.", a: "\"We could do this all night, couldn't we. Someone give us a new one.\" [Respectful Exit]", guideBack: "One way it could sound", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "They clearly want to leave it but can't find the way out.", a: "\"Shall we park that? Tell me about the weekend instead.\" [Respectful Exit]", guideBack: "One way it could sound", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You tried to redirect and they didn't take the hint.", a: "\"Let me be clearer — I think we've done that topic. What else is new with you?\" [Respectful Exit]", guideBack: "One way it could sound", bundle: 'pro' },
        { q: "A gentle bridge landed flat and they carried on.", a: "\"Genuinely, shall we switch it up? Tell me the best part of your week.\" [Respectful Exit]", guideBack: "One way it could sound", bundle: 'pro' },
        ...
        { q: "The group followed you but one person did not.", a: "\"We'll come back to it. Anna was mid-sentence about something.\" [Respectful Exit]", guideBack: "One way it could sound", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You raised something and realised mid-sentence it was the wrong room.", a: "\"I'm going to leave that one there, actually. How was the weekend?\" [Respectful Exit]", guideBack: "One way it could sound", bundle: 'pro' },
        ...
        { q: "Somebody politely tried to keep your dead topic alive.", a: "\"You're being kind. Let it go, it's fine. What's new with you?\" [Respectful Exit]", guideBack: "One way it could sound", bundle: 'pro' },
  ...
  complimenting: [
    {
      ...
      inputs: [
        ...
        { q: "They cannot argue with what it did to you.", a: "\"Whether it was good or not, I've started doing it your way.\" [Why It Landed]", guideBack: "The effect it had on you", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You want to praise your manager without it sounding like flattery.", a: "\"When you took the blame for that in the meeting, it changed how I saw the team.\" [Why It Landed]", guideBack: "The effect it had on you", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "They did something good years ago that you never acknowledged.", a: "\"I never said it at the time: what you did that summer mattered.\" [Why It Landed]", guideBack: "The effect it had on you", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You are about to open a criticism with something nice.", a: "\"This is a criticism and I'm not going to wrap it: the second half doesn't work.\" [Why It Landed]", guideBack: "The effect it had on you", bundle: 'pro' },
