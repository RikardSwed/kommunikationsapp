  ...
  discussing: [
    {
      ...
      inputs: [
        { q: "Every turn starts with \"yeah, but\".", a: "\"I've been saying 'yeah but' for five minutes. Let me actually say your side back.\" [Play It Back]", bundle: 'pro' },
        { q: "You realise you could not summarise their position.", a: "\"I'm not sure I could explain your view to someone else. Say it once more?\" [Play It Back]", bundle: 'pro' },
        { q: "Both of you have made the same point twice.", a: "\"We're both repeating. What would change your mind on this?\" [Ask What They Mean]", bundle: 'pro' },
        { q: "You are waiting to speak rather than listening.", a: "\"I've been queuing rather than listening. What was the last bit?\" [Play It Back]", bundle: 'pro' },
        { q: "The exchange is polite and going nowhere.", a: "\"Can I ask what you'd do if it were entirely your call?\" [Ask What They Mean]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "\"You always do this\" has just been said.", a: "\"We've moved off the subject. Can we go back to the actual question?\" [Keep the Temperature Down]", bundle: 'pro' },
        { q: "Something from another day has been brought in.", a: "\"That's a separate thing and probably worth talking about, but not inside this one.\" [Keep the Temperature Down]", bundle: 'pro' },
        { q: "You are about to say something you would have to take back.", a: "\"I'm going to stop before I say something daft. Give me ten minutes.\" [Keep the Temperature Down]", bundle: 'pro' },
        { q: "The tone has changed and nobody has said so.", a: "\"This has gone a bit tense, hasn't it. I'd rather say that than pretend.\" [Keep the Temperature Down]", bundle: 'pro' },
        { q: "You want to win more than you want to be right.", a: "\"I've stopped listening and started competing. That's on me.\" [Keep the Temperature Down]", bundle: 'pro' },
