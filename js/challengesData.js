...
const challengesCollections = {
  ...
  howtointerrupt: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You have cut in twice and someone quieter has not spoken at all.", a: "\"I'll stop — I think Anna was going to say something.\" [Their Point First]", guideBack: "One line about theirs, then yours", bundle: 'pro' },
        { q: "You are about to interrupt out of impatience rather than need.", a: "(say nothing, wait) \"Go on — sorry.\" [The Natural Pause]", guideBack: "A point held until the gap", bundle: 'pro' },
  ...
  handleinterruptions: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "They interrupt with something genuinely better than your point.", a: "\"That's better than where I was going. Take it.\" [Pick It Up After]", guideBack: "Your point, picked up afterwards", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "The point stopped mattering while you waited.", a: "\"Mine's gone stale now. Carry on.\" [Pick It Up After]", guideBack: "Your point, picked up afterwards", bundle: 'pro' },
      ]
    },
    {
  ...
  praiseandencouragement: [
    ...
    },
    {
      ...
      inputs: [
        { q: "You are about to say \"let me know if you need anything\".", a: "\"Send me the draft on Wednesday and I'll read it.\" [Offer Support]", guideBack: "A concrete offer, not a wish", bundle: 'pro' },
        { q: "You offered something and cannot now do it.", a: "\"I said I'd read it Wednesday and I can't. Thursday morning, definitely.\" [Offer Support]", guideBack: "A concrete offer, not a wish", bundle: 'pro' },
        { q: "They took your vague offer literally and asked for a lot.", a: "\"I can do the first two. The rest I'd not manage well.\" [Offer Support]", guideBack: "A concrete offer, not a wish", bundle: 'pro' },
        { q: "You want to help but genuinely have no time.", a: "\"I can't take any of it on this month. I can point you at who could.\" [Offer Support]", guideBack: "A concrete offer, not a wish", bundle: 'pro' },
        { q: "You are offering mainly to seem supportive.", a: "\"Actually, I'd not get to it. Better you ask someone with the time.\" [Offer Support]", guideBack: "A concrete offer, not a wish", bundle: 'pro' },
        { q: "You want to offer something but do not know what would help.", a: "\"I've got an hour on Friday. What would be most useful?\" [Offer Support]", guideBack: "A concrete offer, not a wish", bundle: 'pro' },
        { q: "You offered and they have not taken it up.", a: "\"Friday's still there if you want it — an hour, whenever.\" [Offer Support]", guideBack: "A concrete offer, not a wish", bundle: 'pro' },
        { q: "You are about to promise something conditional on things going well.", a: "\"Thursday, regardless of how the week goes. I'll be there.\" [Offer Support]", guideBack: "A concrete offer, not a wish", bundle: 'pro' },
      ]
    },
    {
  ...
  apologizing1: [
    ...
    },
    {
      ...
      inputs: [
        { q: "You have apologised twice and they have said it is fine twice.", a: "\"Right — I'll stop apologising. Thanks.\" [Say Sorry Simply]", guideBack: "A bare apology", bundle: 'pro' },
  ...
  sayingno: [
    {
      ...
      inputs: [
        ...
        { q: "You genuinely do need to check something first.", a: "\"Let me check and tell you by tomorrow.\" [Ask for Time First]", guideBack: "A postponement, not a refusal", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You are asked in a meeting and want to answer properly.", a: "\"Let me look at what's already booked and come back to you today.\" [Ask for Time First]", guideBack: "A postponement, not a refusal", bundle: 'pro' },
        ...
        { q: "The request is entirely within their rights.", a: "\"That's fair. I'll do it.\" [Say No Simply]", guideBack: "A plain refusal", bundle: 'pro' },
        { q: "You are asked in front of the team and cannot think.", a: "\"Let me look at the week and come back to you this afternoon.\" [Ask for Time First]", guideBack: "A postponement, not a refusal", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You can feel the old reflex and want to stop it.", a: "\"Let me think about it rather than answering straight away.\" [Ask for Time First]", guideBack: "A postponement, not a refusal", bundle: 'pro' },
  ...
  startingconversations1: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You have tried twice and got very little back.", a: "\"Anyway — enjoy the rest of it.\" [Simple Greeting]", guideBack: "A greeting to open with", bundle: 'pro' },
        { q: "They answered and immediately looked back at their phone.", a: "\"No worries. Cheers.\" [Simple Greeting]", guideBack: "A greeting to open with", bundle: 'pro' },
        ...
        { q: "They answered your question and asked nothing back.", a: "\"Cheers.\" [Simple Greeting]", guideBack: "A greeting to open with", bundle: 'pro' },
  ...
  showunderstanding: [
    ...
    },
    {
      ...
      guideFront: "Choose a strategy when...",
      guideBack: "One way it could sound",
      description: "You relate to what they said, and four sentences later the conversation is about you, and nobody is quite sure how it happened.\n\n**What goes wrong:** your version grows a middle. Two sentences and a question is the whole move; anything with a middle and an ending is a story, and stories take the floor whether or not you meant them to.\n\n**What works here:** **Relate Through Sharing**, kept to two sentences. When it has already gone too far, **Loop Back** is the way back — handing the floor over explicitly is less awkward than trailing off.\n\n**Avoid:** the second example. One matching experience is relating; two is a turn.\n\nMindset: relating is a nod, not a turn. If your version has a middle, cut the middle.",
      inputs: [
        { q: "You are three sentences into your own version.", a: "\"Anyway — yours sounds worse. What happened with the deadline?\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        { q: "You notice they have started asking you questions.", a: "\"We're talking about me now, sorry. Go back to the group thing.\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        ...
        { q: "Someone else joins and asks you about the thing you just mentioned.", a: "\"Later — she was telling me about the group project.\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
        ...
        { q: "They politely wait for your story to finish.", a: "\"That's enough from me. Back to yours.\" [Loop Back]", guideBack: "Their point, in your words", bundle: 'pro' },
      ]
    },
    {
  ...
  changingtopics: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "They keep answering your new topic with the old one.", a: "\"You're clearly not finished with it. Go on, then — say the rest.\" [Acknowledge and Redirect]", guideBack: "A clean handover between subjects", bundle: 'pro' },
        ...
        { q: "They ignored the switch because they had not finished.", a: "\"Fair enough, finish it properly. I jumped in too early.\" [Acknowledge and Redirect]", guideBack: "A clean handover between subjects", bundle: 'pro' },
      ]
    },
    {
  ...
  complimenting: [
    {
      ...
      inputs: [
        { q: "They say \"oh, it was nothing\".", a: "\"It wasn't. The ending specifically — you didn't oversell it.\" [The Specific Thing]", guideBack: "The detail, not the category", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You manage them and want to praise the work.", a: "\"The order you put the sections in is what made it work.\" [The Specific Thing]", guideBack: "The detail, not the category", bundle: 'pro' },
        ...
        { q: "Praise from you might be heard as the start of a request.", a: "\"Nothing attached to this — the report was the clearest one this year.\" [The Specific Thing]", guideBack: "The detail, not the category", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "A friend has clearly made an effort tonight.", a: "\"You've put that together properly. It's very you.\" [The Specific Thing]", guideBack: "The detail, not the category", bundle: 'pro' },
        ...
        { q: "They have obviously changed something and you are not sure what.", a: "\"Something's different and it's working. I can't tell you what it is.\" [The Specific Thing]", guideBack: "The detail, not the category", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You do not actually believe the compliment you are about to give.", a: "(leave it — if you noticed nothing there is nothing to name) [The Specific Thing]", guideBack: "The detail, not the category", bundle: 'pro' },
