...
const challengesCollections = {
  ...
  endingconversations: [
    {
      ...
      inputs: [
        ...
        { q: "They start a new topic straight after you said you were leaving.", a: "\"Save that one for me. I have to run.\" [The Rain Check]", bundle: 'pro' },
        { q: "They say \"one more thing\" for the third time.", a: "\"Sorry, I really can't. Let's do the rest tomorrow.\" [The Rain Check]", bundle: 'pro' },
        { q: "You are already backing away and they keep talking.", a: "\"I'm going to have to stop you there. Take care.\" [The Exit Phrase]", bundle: 'pro' },
        { q: "You have been standing with your coat on for five minutes.", a: "\"Right, I'm going before I miss it entirely. See you.\" [The Exit Phrase]", bundle: 'pro' },
        ...
        { q: "Every time you close it they open something new.", a: "\"You're too interesting. I'm leaving before you start another one.\" [The Parting Joke]", bundle: 'pro' },
        { q: "You have said goodbye twice and are still standing there.", a: "\"Right — before I go, how did the interview end up?\" [One Last Question]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "You are at an event and want to talk to other people.", a: "\"I'm going to do a lap. It was good to meet you.\" [Praise the Talk]", bundle: 'pro' },
        { q: "You are about to invent an appointment that does not exist.", a: "\"Right — I'll let you get on.\" [The Exit Phrase]", bundle: 'pro' },
        ...
        { q: "You are tired and that is the whole of it.", a: "\"I'm going to call it. Good to see you.\" [The Exit Phrase]", bundle: 'pro' },
        { q: "You want to leave but would like to hear one thing first.", a: "\"I have to head off in a minute — but what happened with the flat?\" [One Last Question]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "Someone has told you something difficult and you have to leave.", a: "\"I'm glad you told me. Can we carry this on properly tomorrow?\" [The Rain Check]", bundle: 'pro' },
        { q: "You want to leave without it sounding like you have had enough.", a: "\"I have to go, and I don't want to leave it here. Are you around later?\" [One Last Question]", bundle: 'pro' },
        { q: "A hard conversation has reached its natural end.", a: "\"Thank you for telling me. I mean that.\" [Praise the Talk]", bundle: 'pro' },
        { q: "You are worried about them as you leave.", a: "\"Look after yourself. I'll message you this evening.\" [Wish Them Well]", bundle: 'pro' },
        { q: "You are about to end it with a joke out of awkwardness.", a: "\"Take care. I'll check in tomorrow.\" [The Exit Phrase]", bundle: 'pro' },
        { q: "They have gone quiet and you do not want to leave on the silence.", a: "\"I'm going to go — not because of any of this. Talk tomorrow?\" [The Rain Check]", bundle: 'pro' },
        { q: "You said you would help and now you are leaving.", a: "\"I meant what I said about Thursday. I'll be there.\" [The Rain Check]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You want to slip away from a group mid-conversation.", a: "\"I'm going to head off — night, all.\" [The Exit Phrase]", bundle: 'pro' },
        { q: "You do not want to interrupt the conversation to leave.", a: "\"I'm off. Good to see you.\" (quietly, to the person nearest) [The Exit Phrase]", bundle: 'pro' },
        { q: "You announced you were leaving and then stayed.", a: "\"Right, this time I mean it. Night.\" [The Parting Joke]", bundle: 'pro' },
        { q: "You want to leave a group where you know one person well.", a: "\"I'm going to go. Message me about Saturday.\" [The Rain Check]", bundle: 'pro' },
        ...
        { q: "You are the first to leave and nobody else is moving.", a: "\"Someone has to go first. I'll take it. Night, all.\" [The Parting Joke]", bundle: 'pro' },
        { q: "You have been talking to one person while the group waits.", a: "\"I'll let you get back to everyone. Good to talk.\" [Praise the Talk]", bundle: 'pro' },
        { q: "You are leaving a group where you barely know anyone.", a: "\"I'm going to head off — nice to have met you all.\" [Praise the Talk]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "They are clearly trying to leave and being too polite about it.", a: "\"You've got that look. Go on, off you go.\" [The Parting Joke]", bundle: 'pro' },
        { q: "They leave mid-topic and you would like to finish it.", a: "\"We'll pick this up. Take care.\" [The Rain Check]", bundle: 'pro' },
        { q: "They end it just as you were getting to the point.", a: "\"Go — I'll send you the rest in a message.\" [The Rain Check]", bundle: 'pro' },
        ...
        { q: "They end it and you have one thing you actually need to know.", a: "\"Before you go — is Friday still on?\" [One Last Question]", bundle: 'pro' },
      ]
    },
  ],
  reactingtounexpectedstatements: [
    {
      ...
      inputs: [
        { q: "Someone says something you find genuinely objectionable.", a: "\"I don't know what to say to that, honestly.\" [Admit the Blank]", bundle: 'pro' },
        { q: "You want to register that it landed without starting a row.", a: "\"Give me a second — that's not what I expected to hear.\" [Name the Pause]", bundle: 'pro' },
        { q: "You want to understand before deciding how to respond.", a: "\"What made you say that?\" [Ask What Prompted It]", bundle: 'pro' },
        { q: "You can name your reaction but not your position.", a: "\"I don't have an argument ready. It did make me uncomfortable.\" [Answer Part of It]", bundle: 'pro' },
        { q: "It needs saying properly and this is not the moment.", a: "\"I want to come back to that. Not here, though.\" [Park It]", bundle: 'pro' },
        ...
        { q: "You can feel yourself about to perform outrage.", a: "\"Hang on. I want to answer that properly, not quickly.\" [Name the Pause]", bundle: 'pro' },
        { q: "You object to the framing but not the underlying point.", a: "\"The underlying thing I'd discuss. The way you put it I wouldn't.\" [Answer Part of It]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "Someone tells you something serious about their health.", a: "\"I don't know what to say. I'm really glad you told me, though.\" [Admit the Blank]", bundle: 'pro' },
        { q: "You are about to reach for something comforting and hollow.", a: "\"I've got nothing wise. I do want to know how you are.\" [Answer Part of It]", bundle: 'pro' },
        ...
        { q: "You need a moment before you can respond at all.", a: "\"God. Give me a second — I wasn't expecting that.\" [Name the Pause]", bundle: 'pro' },
        { q: "You want to make sure the conversation continues.", a: "\"Can I check in with you next week? Not to fix anything.\" [Park It]", bundle: 'pro' },
        { q: "They tell you and then immediately change the subject.", a: "\"We can leave it — but I heard it, and I'd like to come back to it.\" [Park It]", bundle: 'pro' },
        { q: "They tell you something you already half suspected.", a: "\"I wondered. I'm glad you've said it out loud.\" [Answer Part of It]", bundle: 'pro' },
        { q: "You are worried anything you say will sound rehearsed.", a: "\"I've got no good sentence for this. I'm here, though.\" [Admit the Blank]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "The counter-argument is assembling itself and you have not decided to use it.", a: "\"Let me think about that for a second.\" [Name the Pause]", bundle: 'pro' },
        ...
        { q: "You agree with part of it and not the rest.", a: "\"The first bit I'd agree with. The rest I'd want to think about.\" [Answer Part of It]", bundle: 'pro' },
        { q: "It is worth discussing but not here and not now.", a: "\"I'd like to come back to that properly sometime.\" [Park It]", bundle: 'pro' },
        ...
        { q: "Other people are agreeing and you are not.", a: "\"I'm the odd one out here. Give me a minute with it.\" [Name the Pause]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You sounded certain and were not.", a: "\"I sounded clear. I wasn't — that was a reaction.\" [Admit the Blank]", bundle: 'pro' },
        { q: "You want to replace the reaction with what you actually think.", a: "\"The first half I do agree with. The second half I still don't know.\" [Answer Part of It]", bundle: 'pro' },
        ...
        { q: "You went quiet and they read it as disapproval.", a: "\"That was me thinking, not judging. Sorry — say it again?\" [Name the Pause]", bundle: 'pro' },
        { q: "You agreed too readily and now regret it.", a: "\"I said yes too fast yesterday. Can we go back to it?\" [Park It]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "Something lands in a meeting and everyone looks at you.", a: "\"I'd want to think about that before I answer.\" [Park It]", bundle: 'pro' },
        { q: "You want to say something honest without opening it up publicly.", a: "\"I don't have a view on that yet.\" [Admit the Blank]", bundle: 'pro' },
        { q: "The silence is becoming conspicuous.", a: "\"Give me a second — I'm thinking.\" [Name the Pause]", bundle: 'pro' },
        { q: "You can answer the practical part in the room.", a: "\"The dates I can answer. The rest I'd want to come back on.\" [Answer Part of It]", bundle: 'pro' },
        { q: "You catch them privately afterwards.", a: "\"What you said in there — what was behind it?\" [Ask What Prompted It]", bundle: 'pro' },
        { q: "Someone puts you on the spot about a decision.", a: "\"I'll answer that properly by the end of the day.\" [Park It]", bundle: 'pro' },
        { q: "They say something about you in front of the team.", a: "\"That's worth talking about. Can we do it after?\" [Park It]", bundle: 'pro' },
        { q: "You want to say the honest thing but not all of it here.", a: "\"Some of it I can answer now. The rest I'd rather do properly.\" [Answer Part of It]", bundle: 'pro' },
      ]
    },
  ],
  deepquestions: [
  ...
  handleinterruptions: [
    {
      ...
      inputs: [
        ...
        { q: "A friend interrupts every couple of sentences as you talk.", a: "\"Tell you what — let me get through this, and I'll hand straight over.\" [Their Turn Next]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "A friend cuts in, thrilled: \"Oh that happened to me too!\"", a: "\"Love it — hold that, I want to hear it the second I'm done.\" [Their Turn Next]", bundle: 'pro' },
        ...
        { q: "Someone interrupts to add an eager \"yes, and—\".", a: "\"Save the 'and' one sec — I'm nearly at it.\" [Their Turn Next]", bundle: 'pro' },
        ...
        { q: "They interrupt with something genuinely better than your point.", a: "\"That's better than where I was going. Take it.\" [Pick It Up After]", bundle: 'pro' },
        ...
        { q: "Their excitement has taken the story somewhere else.", a: "\"We'll get there — I've got one more bit first.\" [Their Turn Next]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "Three people are talking and your point keeps getting buried.", a: "\"Can I jump back in? I didn't get to finish earlier.\" [Pick It Up After]", bundle: 'pro' },
        { q: "The group moved on before you completed your idea.", a: "\"Quick rewind — I still want to land what I started.\" [Pick It Up After]", bundle: 'pro' },
        ...
        { q: "Your contribution got lost in the crosstalk.", a: "\"One thing before we move on — I hadn't finished my point.\" [Pick It Up After]", bundle: 'pro' },
        ...
        { q: "Someone else notices and tries to hand it back to you.", a: "\"Thanks — yes, what I was getting at was —\" [Pick It Up After]", bundle: 'pro' },
        { q: "The point stopped mattering while you waited.", a: "\"Mine's gone stale now. Carry on.\" [Pick It Up After]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "Your boss jumps in and the room defers to them.", a: "\"…circling back, the point I was making was —\" [Pick It Up After]", bundle: 'pro' },
        ...
        { q: "They cut in and the room is now looking at them.", a: "(wait, then) \"To close mine off — it was the timing I was worried about.\" [Pick It Up After]", bundle: 'pro' },
        { q: "You need to finish and they are clearly not going to stop.", a: "\"I'll send the rest in writing so it doesn't get lost.\" [Pick It Up After]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "Someone interrupts and the whole topic shifts away from your point.", a: "\"Before we lose it — I hadn't finished what I was saying.\" [Pick It Up After]", bundle: 'pro' },
        { q: "A cut-in sends the conversation off on a tangent.", a: "\"Let me pull us back for one sec — my point still stands.\" [Pick It Up After]", bundle: 'pro' },
        ...
        { q: "Your idea gets abandoned after someone jumps in.", a: "\"Let me resurface that — I think it's still the key thing.\" [Pick It Up After]", bundle: 'pro' },
        ...
        { q: "The new subject is more urgent than yours.", a: "\"That's bigger — deal with that. Mine can wait.\" [Pick It Up After]", bundle: 'pro' },
  ...
  describethings: [
    {
      ...
      inputs: [
        ...
        { q: "You have listed three adjectives and none has landed.", a: "\"Forget all that — the giveaway is the cracked corner on the lid.\" [Name and Main Details]", bundle: 'pro' },
        { q: "You said \"it's just a normal one\".", a: "\"Sorry, that's no help. It's the round sort, not the flat sort.\" [Size and Shape]", bundle: 'pro' },
        { q: "They ask \"which one?\" for the third time.", a: "\"The one right next to the door. That's the quickest way to say it.\" [Where You Find It]", bundle: 'pro' },
        { q: "You said \"over there\" and they are looking the wrong way.", a: "\"Behind you, second shelf down, next to the kettle.\" [Where You Find It]", bundle: 'pro' },
        { q: "You said \"the big one\" and there are three big ones.", a: "\"The tallest of the three — about up to your elbow.\" [Size and Shape]", bundle: 'pro' },
        { q: "You described the type but not which one.", a: "\"It's the matt black one. The others are all shiny.\" [Material, Texture and Colour]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "They say \"hang on, go back\".", a: "\"The bag. Green, with a yellow patch on the front.\" [Name and Main Details]", bundle: 'pro' },
        ...
        { q: "You realise you have not said the one thing that identifies it.", a: "\"None of that matters, actually. It's the only one with a wooden handle.\" [Name and Main Details]", bundle: 'pro' },
        { q: "They look overwhelmed before you have finished.", a: "\"Short version: big, green, patched. That's enough to spot it.\" [Name and Main Details]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "They press for the brand.", a: "\"No idea on the brand. I could tell you the shape though.\" [Size and Shape]", bundle: 'pro' },
        { q: "You half remember and it might be wrong.", a: "\"I think it was green — don't rule out a blue one on my say-so.\" [Material, Texture and Colour]", bundle: 'pro' },
        { q: "You realise mid-sentence you have described something else.", a: "\"Sorry, I'm describing the old one. The new one is smaller and grey.\" [Size and Shape]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "The comparison is close but the size is wrong.", a: "\"Like a wheelbarrow, but you'd carry it in one hand.\" [Size and Shape]", bundle: 'pro' },
        { q: "They cannot picture the material at all.", a: "\"Heavier than it looks — cast iron, cold to hold.\" [Material, Texture and Colour]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "They have never met the person and you need them to spot her.", a: "\"A bit like Sara from the shop — same height, same glasses.\" [What It Is Like]", bundle: 'pro' },
        { q: "They are in a crowd and everyone is dressed the same.", a: "\"Third from the left, right under the clock.\" [Where You Find It]", bundle: 'pro' },
        { q: "You realise the detail you were going to use is the wrong thing to say.", a: "\"She's the one by the window with the red lanyard.\" [Material, Texture and Colour]", bundle: 'pro' },
        { q: "They have moved since you described them.", a: "\"Forget where — he's the tallest person in the room.\" [Size and Shape]", bundle: 'pro' },
      ]
    },
  ],
  explainthings: [
    {
      ...
      inputs: [
        { q: "You're two sentences into explaining and they say, \"Yeah, I've used one before.\"", a: "\"Then I'll skip to what changed — it does the ordering for you now.\" [How It Works]", bundle: 'pro' },
        { q: "They finish your sentence for you.", a: "\"You're ahead of me. The only new thing is that it runs on Sundays too.\" [What It Is]", bundle: 'pro' },
        { q: "They say \"I know\" flatly, twice.", a: "\"Right — then the bit people miss: nobody has to remember to start it.\" [Why It Matters]", bundle: 'pro' },
        { q: "You realise they wrote the thing you're explaining.", a: "\"I've just explained your own system to you. The only thing I've added is the second check.\" [How It Works]", bundle: 'pro' },
        { q: "They're nodding along politely but clearly ahead of you.", a: "\"I'm labouring this. Shall I skip to the bit about why it changed?\" [Why It Matters]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "Their eyes have gone somewhere else and you're still on the parts list.", a: "\"I'm going too deep. One sentence: it stops the pipes freezing.\" [Why It Matters]", bundle: 'pro' },
        { q: "They say \"okay…\" three times in a row with no question.", a: "\"Let me start again shorter. The whole of it is: it emails you the day before.\" [What It Is]", bundle: 'pro' },
        { q: "You're four minutes in and haven't said what it's for.", a: "\"I've buried the point. It's for the mornings when you can't get up.\" [Why It Matters]", bundle: 'pro' },
        { q: "They interrupt with \"sorry, what does it do again?\"", a: "\"Good question — I never said. It logs the temperature every ten minutes.\" [How It Works]", bundle: 'pro' },
        { q: "You notice you've used three words they wouldn't know.", a: "\"Ignore all that. In plain terms, it's a switch that turns itself off.\" [What It Is]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You don't know if they know the basics or not.", a: "\"It's a shared list two people can edit at once. Stop me if you've got that bit.\" [What It Is]", bundle: 'pro' },
        { q: "A child asked and you've started with the technical answer.", a: "\"Let me do that again properly. It's a box that keeps food cold so it doesn't go bad.\" [What It Is]", bundle: 'pro' },
        { q: "An expert asked and you've started from the very beginning.", a: "\"Straight to the change, then: the queue is per-room now, not per-building.\" [How It Works]", bundle: 'pro' },
        { q: "They say \"I'm not technical\" before you've said anything.", a: "\"That's fine, there's nothing technical in it. It's a list and a button.\" [What It Is]", bundle: 'pro' },
        { q: "They use a technical word correctly and you'd been simplifying.", a: "\"Ah, you're further in than I thought. Then the short version is it caches locally.\" [How It Works]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "They say, \"I get what it is, I just don't see the point.\"", a: "\"It's for people juggling three calendars. If that's not you, it isn't much.\" [Why It Matters]", bundle: 'pro' },
        { q: "They shrug and say, \"I've managed fine without one.\"", a: "\"You have. The only thing it changes is the Sunday-night panic.\" [Why It Matters]", bundle: 'pro' },
        { q: "They say, \"Sounds like more work than it saves.\"", a: "\"It is, for the first week. After that it's about ten minutes a day back.\" [Why It Matters]", bundle: 'pro' },
        { q: "They ask what's wrong with the old way.", a: "\"Nothing, honestly, until two people need it at once. That's the whole difference.\" [Why It Matters]", bundle: 'pro' },
        { q: "They say, \"This feels like a solution looking for a problem.\"", a: "\"The problem is the Monday where two people booked the same room.\" [Why It Matters]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "They ask a follow-up you can't answer.", a: "\"That's past where I know. What I can tell you is why it's there: nothing gets lost overnight.\" [Why It Matters]", bundle: 'pro' },
        { q: "You could bluff and they'd probably not notice.", a: "\"I don't know how it does that. What it does is put a copy in the shared folder.\" [What It Is]", bundle: 'pro' },
        { q: "You know who does know.", a: "\"Sam knows the inside of it. The shape of it is: it runs, it checks, it files.\" [How It Works]", bundle: 'pro' },
        { q: "You half remember and it might be wrong.", a: "\"Don't hold me to the timing. The part I'm sure of is that it only ever adds, never deletes.\" [How It Works]", bundle: 'pro' },
        { q: "They press for a definite answer you don't have.", a: "\"I'd be guessing on the number. What it's for is clear enough: one place instead of four.\" [Why It Matters]", bundle: 'pro' },
  ...
  praiseandencouragement: [
    {
      ...
      inputs: [
        ...
        { q: "They brace as soon as you start praising, because it has always come with a but.", a: "\"Nothing's coming after this one. The way you handled the client was good.\" [Name the Positive Action]", bundle: 'pro' },
        { q: "They flinch when you start with a compliment.", a: "\"This one isn't leading anywhere. It's just the thing you did well.\" [Name the Positive Action]", bundle: 'pro' },
        { q: "You want to encourage and correct at once.", a: "\"Keep the structure. That's the whole note for today.\" [Keep Going]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "The work was weak and you want to say something kind.", a: "\"The research underneath it is solid. That's the part I'd keep.\" [Name the Positive Action]", bundle: 'pro' },
        { q: "You cannot find anything about the result to praise.", a: "\"You got it done in the week you said you would. That's not nothing.\" [Name the Positive Action]", bundle: 'pro' },
        { q: "They ask directly if it was good and it was not.", a: "\"Parts of it. The opening works. I'd want to talk about the middle.\" [Name the Positive Action]", bundle: 'pro' },
        { q: "You have been generous about everything and it has stopped meaning anything.", a: "\"This one I actually mean: the second half is much stronger than the first.\" [Name the Positive Action]", bundle: 'pro' },
        { q: "You are about to say something you do not mean.", a: "\"I won't pretend it landed. What I do think is that it was worth trying.\" [Keep Going]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "They took your vague offer literally and asked for a lot.", a: "\"I can do the first two. The rest I'd not manage well.\" [Offer Support]", bundle: 'pro' },
        { q: "You want to help but genuinely have no time.", a: "\"I can't take any of it on this month. I can point you at who could.\" [Offer Support]", bundle: 'pro' },
        { q: "You are offering mainly to seem supportive.", a: "\"Actually, I'd not get to it. Better you ask someone with the time.\" [Offer Support]", bundle: 'pro' },
        { q: "You want to offer something but do not know what would help.", a: "\"I've got an hour on Friday. What would be most useful?\" [Offer Support]", bundle: 'pro' },
        { q: "You offered and they have not taken it up.", a: "\"Friday's still there if you want it — an hour, whenever.\" [Offer Support]", bundle: 'pro' },
        { q: "You are about to promise something conditional on things going well.", a: "\"Thursday, regardless of how the week goes. I'll be there.\" [Offer Support]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "They credit the whole thing to someone else.", a: "\"They helped. The bit I mean is the part you did.\" [Name the Positive Action]", bundle: 'pro' },
        { q: "They laugh it off every time.", a: "\"I know you'll wave that away. I'm saying it anyway.\" [Name the Positive Action]", bundle: 'pro' },
        { q: "They say you are only being kind.", a: "\"I'd have said nothing if I didn't mean it. That's how I work.\" [Express Appreciation]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "Praising one person might read as a dig at the others.", a: "\"The group got this done, and Sam's summary is what held it together.\" [Highlight the Impact]", bundle: 'pro' },
        { q: "They deflect the public praise and the room goes quiet.", a: "\"Fair enough — I'll leave it there. It did make the difference, though.\" [Highlight the Impact]", bundle: 'pro' },
        { q: "You want to thank someone in front of others without making a speech of it.", a: "\"One thing before we start — that was a real help last week. Thank you.\" [Express Appreciation]", bundle: 'pro' },
  ...
  apologizing1: [
    {
      ...
      inputs: [
        { q: "You are about to say \"I'm sorry you feel that way\".", a: "\"I'm sorry I said it. Not that you're upset — that I said it.\" [What You Did]", bundle: 'pro' },
        { q: "You are about to say \"sorry, but you did too\".", a: "\"I'm sorry for my part. We can do the rest separately.\" [What You Did]", bundle: 'pro' },
        ...
        { q: "You are about to say \"sorry if that upset anyone\".", a: "\"I'm sorry for the message I sent yesterday. It was unfair to Priya.\" [What You Did]", bundle: 'pro' },
        ...
        { q: "You are about to say \"sorry, that's just how I am\".", a: "\"I'm sorry I snapped. That's on me, not on how I'm built.\" [What You Did]", bundle: 'pro' },
        { q: "You want to apologise without naming what you did.", a: "\"I'm sorry I forgot the pickup. Not 'for the mix-up' — I forgot it.\" [What You Did]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "They have started reassuring you and comforting you.", a: "\"You don't need to make me feel better about it. It was my mistake.\" [What You Did]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You are about to say \"I'll be more careful\".", a: "\"I'll put it in the calendar while we're talking. That's the actual change.\" [The Plan]", bundle: 'pro' },
        { q: "You are about to say \"it won't happen again\".", a: "\"It might. What I'll do is text you the moment I know I'm running late.\" [The Plan]", bundle: 'pro' },
        { q: "They ask what will be different this time.", a: "\"A reminder two days before. Last time it was in my head, which is why it failed.\" [The Plan]", bundle: 'pro' },
        { q: "You genuinely do not know how to prevent it.", a: "\"I don't know what would stop it. Have you got an idea? I'd take it.\" [The Plan]", bundle: 'pro' },
        { q: "You made a plan last time and did not keep it.", a: "\"I said that last time and didn't do it. So this time it's written down.\" [The Plan]", bundle: 'pro' },
        { q: "You are about to promise something you cannot control.", a: "\"I can't promise the trains. I can promise I'll leave at seven.\" [The Plan]", bundle: 'pro' },
        { q: "Your plan is a feeling rather than an action.", a: "\"Not 'I'll focus more' — I'll put my phone in the drawer.\" [The Plan]", bundle: 'pro' },
        { q: "The change is small and you are embarrassed by it.", a: "\"It's just a reminder on the Sunday. Small, but it's the thing that failed.\" [The Plan]", bundle: 'pro' },
      ]
    },
    {
      name: "You Do Not Think You Were Wrong",
      ...
      inputs: [
        { q: "You stand by the decision but not how you said it.", a: "\"The tone was wrong and I'm sorry for it. The decision I'd still make.\" [What You Did]", bundle: 'pro' },
        { q: "You were right but they heard it from someone else.", a: "\"You should have heard it from me first. That part's on me.\" [What You Did]", bundle: 'pro' },
        ...
        { q: "They want you to agree you were wrong and you do not.", a: "\"I don't think I was wrong about the thing. I do think I handled it badly.\" [What You Did]", bundle: 'pro' },
        ...
        { q: "You would do the same again but said it badly.", a: "\"I'm sorry for how I put it in front of everyone.\" [What You Did]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "The same thing has happened three times.", a: "\"I keep apologising for this and it keeps happening. That's the thing to talk about.\" [The Plan]", bundle: 'pro' },
        ...
        { q: "They ask what you are actually going to do about it.", a: "\"Fair question. From Monday it goes in the shared calendar, not my head.\" [The Plan]", bundle: 'pro' },
      ]
    },
  ],
  agreeing: [
  ...
  disagreeing: [
    {
      ...
      inputs: [
        { q: "They say, \"So you think I'm wrong about everything.\"", a: "\"Not everything, and not you. This one thing, and I might be the wrong one.\" [Signal the Disagreement]", bundle: 'pro' },
        { q: "They go quiet and stiff after your disagreement.", a: "\"I've come across sharper than I meant. I'm arguing with the plan, not you.\" [Signal the Disagreement]", bundle: 'pro' },
        { q: "They say, \"You always do this.\"", a: "\"Maybe I do. Here's why this one: the last two both slipped at handover.\" [Give Your Reason]", bundle: 'pro' },
        { q: "They start defending themselves rather than the idea.", a: "\"You don't need to defend yourself here — I'm only stuck on the date.\" [Signal the Disagreement]", bundle: 'pro' },
        { q: "You realise your disagreement sounded like a correction.", a: "\"Let me say that better. I think it works, and I'd start it later.\" [Signal the Disagreement]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "Everyone has nodded and you have not.", a: "\"Can I be the awkward one? I'm not sure about this.\" [Signal the Disagreement]", bundle: 'pro' },
        { q: "You have left it too long and the topic has moved on.", a: "\"Sorry to go back — I never said what I actually think about the last one.\" [Signal the Disagreement]", bundle: 'pro' },
        { q: "They ask if everyone is agreed and you are not.", a: "\"Not quite. One thing I'd want to flag before we go ahead.\" [Signal the Disagreement]", bundle: 'pro' },
        { q: "You have said your piece and the room has moved past it.", a: "\"I've said it and I'll leave it there. If it goes wrong it'll be the handover.\" [Give Your Reason]", bundle: 'pro' },
        { q: "Someone says \"we all think this\".", a: "\"Most of us. I'd put myself down as unconvinced rather than opposed.\" [Signal the Disagreement]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "They say \"it just is\" for the second time.", a: "\"I'll put mine on the table then: the last two both slipped at handover.\" [Give Your Reason]", bundle: 'pro' },
        { q: "They repeat their point louder.", a: "\"Louder doesn't move me, but this might: we tried it in March and it cost a week.\" [Add an Example]", bundle: 'pro' },
        { q: "They say \"everyone knows that\".", a: "\"Then I'm the one who doesn't. My reason for doubting is that nobody owns it afterwards.\" [Give Your Reason]", bundle: 'pro' },
        { q: "You are both restating for the third time.", a: "\"We're going round. Different angle: this is a staffing question, not a calendar one.\" [A Wider Picture]", bundle: 'pro' },
        { q: "They dismiss your reason without answering it.", a: "\"You've not answered it, so I'll leave it standing: two people are off that week.\" [Give Your Reason]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "Their answer is better than your objection.", a: "\"That's a fair answer. Then I'm only left with the timing.\" [Signal the Disagreement]", bundle: 'pro' },
        { q: "You realise you argued from something you had not checked.", a: "\"I was working from something I hadn't checked, so take that one out. The rest still stands.\" [Give Your Reason]", bundle: 'pro' },
        { q: "Half your objection stands and half does not.", a: "\"You've answered the cost. What's left is what happens at handover.\" [Give Your Reason]", bundle: 'pro' },
        { q: "You want to keep arguing mainly because you started.", a: "\"I've run out of reasons and I'm still talking. Go with yours.\" [Signal the Disagreement]", bundle: 'pro' },
        { q: "They ask if you are convinced.", a: "\"Mostly. The one thing I'd still put on the table is the March one.\" [Add an Example]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "The difference is real but changes nothing.", a: "\"Different from what I'd have done, and it makes no odds. Go ahead.\" [Signal the Disagreement]", bundle: 'pro' },
        { q: "It is their decision and their consequences.", a: "\"My reason for hesitating is the cost. It's your call and I'll back it.\" [Give Your Reason]", bundle: 'pro' },
        { q: "Everyone is tired and it is late.", a: "\"One angle before we stop: it might be a staffing problem rather than a date one.\" [A Wider Picture]", bundle: 'pro' },
        { q: "You notice you are about to argue for the sake of it.", a: "\"Ignore that — I was about to argue from a bad week, not a real reason.\" [Give Your Reason]", bundle: 'pro' },
        { q: "You said nothing and it is still bothering you a day later.", a: "\"Can I go back to yesterday? There's a case I should have mentioned — the March one.\" [Add an Example]", bundle: 'pro' },
  ...
  persuasionandinfluence1: [
    {
      ...
      inputs: [
        { q: "They shrug and say it makes no difference to them.", a: "\"It'd be the difference between a calm October and the usual one.\" [What They Get]", bundle: 'pro' },
        { q: "They say it is not really their area.", a: "\"It isn't. It's still twenty minutes of your week, every week.\" [The Cost of Doing Nothing]", bundle: 'pro' },
        { q: "They have not read what you sent.", a: "\"Short version: we redo the last section every single time.\" [The Cost of Doing Nothing]", bundle: 'pro' },
        { q: "They say they do not have a view.", a: "\"When we did it the other way in March it cost us a week. That's my whole case.\" [Your Own Story]", bundle: 'pro' },
        { q: "You have been making the case to someone with no stake.", a: "\"There's genuinely nothing in it for you. I'm asking as a favour.\" [What They Get]", bundle: 'pro' },
        { q: "They are listening politely and clearly waiting for you to finish.", a: "\"One thing and I'll stop: it takes the Friday panic off you.\" [What They Get]", bundle: 'pro' },
        { q: "They asked why you care so much.", a: "\"Because I did it the other way for a year and lost most of my Sundays.\" [Your Own Story]", bundle: 'pro' },
        { q: "They agree it is a problem but not their problem.", a: "\"It's the reason your requests come in late. That's the connection.\" [What They Get]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "They say the current way works fine.", a: "\"It works because someone rescues it every time. That's the cost.\" [The Cost of Doing Nothing]", bundle: 'pro' },
        { q: "They say there is no urgency.", a: "\"There isn't. It's an afternoon a month, and it has been for two years.\" [The Cost of Doing Nothing]", bundle: 'pro' },
        { q: "Nobody wants to reopen the question.", a: "\"If we leave it, we'll be having this conversation again in March.\" [The Cost of Doing Nothing]", bundle: 'pro' },
        { q: "You are about to overstate the cost.", a: "\"It's not a crisis. It's twenty minutes a week and it never stops.\" [The Cost of Doing Nothing]", bundle: 'pro' },
        { q: "The cost lands on someone not in the room.", a: "\"We don't feel it. The night team does, and they can't change it.\" [The Cost of Doing Nothing]", bundle: 'pro' },
        { q: "They think doing nothing is free because nothing breaks.", a: "\"Nothing breaks because Priya fixes it every Thursday.\" [The Cost of Doing Nothing]", bundle: 'pro' },
        { q: "They would rather decide next quarter.", a: "\"Then it's another quarter of the same afternoon every month.\" [The Cost of Doing Nothing]", bundle: 'pro' },
        { q: "They say the risk of changing is higher than the risk of staying.", a: "\"It might be. Staying costs about a day a month, and we know that number.\" [The Cost of Doing Nothing]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "They ask whether you have actually seen it work.", a: "\"I did it in the spring. It took half the time.\" [Your Own Story]", bundle: 'pro' },
        { q: "They say your situation was different.", a: "\"It was, in some ways. The part that's the same is the timing.\" [Your Own Story]", bundle: 'pro' },
        { q: "They want to know what happens when it goes wrong.", a: "\"It did go wrong for me once. It cost an hour, not a day.\" [Your Own Story]", bundle: 'pro' },
        { q: "They think your team is not comparable.", a: "\"We're smaller, true. The bit that transfers is the handover.\" [Your Own Story]", bundle: 'pro' },
        { q: "They believe it but cannot see themselves doing it.", a: "\"You'd have it running before lunch. That was my whole setup.\" [What They Get]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "Their version turns out to be cheaper for them.", a: "\"Yours costs you less and I hadn't weighed that properly.\" [What They Get]", bundle: 'pro' },
        { q: "You want to concede without abandoning it entirely.", a: "\"You're right for this year. It'll still be an afternoon a month until we look again.\" [The Cost of Doing Nothing]", bundle: 'pro' },
        ...
        { q: "You realise your example does not support what you claimed.", a: "\"My case was smaller than this one. It doesn't prove what I said it did.\" [Your Own Story]", bundle: 'pro' },
        { q: "They are right about the cost and you were guessing.", a: "\"I said an afternoon. I don't actually know — I was estimating.\" [The Cost of Doing Nothing]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "You are inventing a benefit for them because you need one.", a: "\"There isn't much in it for you, honestly. I'm asking as a favour.\" [What They Get]", bundle: 'pro' },
        { q: "You are about to imply your experience was more typical than it was.", a: "\"That was one case, and my situation was easier than yours.\" [Your Own Story]", bundle: 'pro' },
        ...
        { q: "You are about to say \"everyone is doing it\".", a: "\"One other team does it. That's the whole evidence.\" [Your Own Story]", bundle: 'pro' },
        { q: "The benefit you are naming is mostly yours.", a: "\"Honestly, most of the gain is mine. Yours is that I stop asking.\" [What They Get]", bundle: 'pro' },
      ]
    },
  ],
  ...
  brokenrecord: [
    {
      ...
      inputs: [
        ...
        { q: "You have started offering reasons you had decided not to give.", a: "\"I don't want to get into the reasons. The answer's no.\" [Just the Position]", bundle: 'pro' },
        ...
        { q: "You have started explaining yourself mid-sentence.", a: "\"It doesn't work for me. That's the whole of it.\" [Just the Position]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You are not sure whether it is new information or a new argument.", a: "\"Give me a second — is that different from what we started with?\" [Stay on Your Line]", bundle: 'pro' },
        ...
        { q: "They present an opinion as though it were a new fact.", a: "\"That's still how you see it rather than something new. My answer's the same.\" [Stay on Your Line]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You are asked why not, and would rather not say.", a: "\"I'd rather not go into the details, but I'm not available this week.\" [Just the Position]", bundle: 'pro' },
        ...
        { q: "They start listing everything else you have turned down.", a: "\"We can go through that separately. This week I can't take it on.\" [Stay on Your Line]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You gave a reason last time and they have been arguing with it since.", a: "\"Let's leave the reason out of it. The answer is no.\" [Just the Position]", bundle: 'pro' },
  ...
  makingrequests: [
    {
      ...
      inputs: [
        { q: "You have mentioned it three times and nothing has changed.", a: "\"Could you do your washing up the same evening from now on?\" [The Actual Request]", bundle: 'pro' },
        { q: "You can hear the resentment about to arrive in your voice.", a: "\"This is going to sound bigger than it is, and that's my fault for not saying it before.\" [The Actual Request]", bundle: 'pro' },
        { q: "They say they had no idea it bothered you.", a: "\"That's fair — I hinted instead of asking. Could you handle Wednesdays?\" [The Actual Request]", bundle: 'pro' },
        ...
        { q: "You are about to sigh loudly and hope they notice.", a: "\"Could you take the bins out on Thursdays? That's the ask.\" [The Actual Request]", bundle: 'pro' },
        { q: "You have been saying \"someone should\" for a month.", a: "\"I'd like you to do it. Someone means you and I should have said so.\" [The Actual Request]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You want to ask your manager for a change to your hours.", a: "\"Could I start at ten on Wednesdays from next month?\" [The Actual Request]", bundle: 'pro' },
        ...
        { q: "You are asking for something nobody else has had.", a: "\"I know it's not standard. I'd still like to ask for it.\" [The Actual Request]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "They have already helped twice this month.", a: "\"I've asked you a lot lately. Could you do one more thing on Saturday?\" [The Actual Request]", bundle: 'pro' },
        ...
        { q: "You are about to bury the ask in an apology.", a: "\"Small favour: could you pick me up at six?\" [The Actual Request]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You are asking for something they already agreed to.", a: "\"You said you'd have the March figures by today. Where are they?\" [The Actual Request]", bundle: 'pro' },
        ...
        { q: "You are dressing a decision up as a question.", a: "\"I'm telling you rather than asking: the report's due Friday and it's yours.\" [The Actual Request]", bundle: 'pro' },
        ...
        { q: "You are phrasing a deadline as a favour.", a: "\"This one isn't optional, so I'll say it straight: it needs to be in by Friday.\" [The Actual Request]", bundle: 'pro' },
        { q: "You want to be honest that there is only one answer.", a: "\"I'm telling you rather than asking. It's already been decided upstairs.\" [The Actual Request]", bundle: 'pro' },
  ...
  sayingno: [
    ...
    },
    {
      ...
      inputs: [
        { q: "You said no and feel terrible about it.", a: "\"I know it's not what you wanted, and I still can't.\" [Understand First]", bundle: 'pro' },
        ...
        { q: "You want to acknowledge the cost to them.", a: "\"This does land badly for you and I'm sorry about that.\" [Understand First]", bundle: 'pro' },
        { q: "You are apologising repeatedly for a reasonable no.", a: "\"I'll stop apologising. It's just a no.\" [Say No Simply]", bundle: 'pro' },
        { q: "There is something small you could genuinely offer.", a: "\"I can't do the day. I could do an hour on Sunday.\" [The Half Yes]", bundle: 'pro' },
        { q: "You want them to know you did think about it.", a: "\"I did sit with this one. It's still a no.\" [Understand First]", bundle: 'pro' },
        ...
        { q: "There is a smaller version of it you would happily do.", a: "\"Not the whole weekend. I'll do the Saturday morning.\" [The Half Yes]", bundle: 'pro' },
      ]
    },
    {
      name: "They Have Power Over You",
      ...
      inputs: [
        { q: "A manager asks you to take on something outside your capacity.", a: "\"I can do it, but not alongside the March work. Which would you rather I dropped?\" [The Half Yes]", bundle: 'pro' },
        { q: "You want to decline without it sounding like refusal.", a: "\"I understand it needs doing. I can't get to it this week — Monday I could.\" [Understand First]", bundle: 'pro' },
        ...
        { q: "Saying yes would mean something else slips.", a: "\"I can take it if the report moves to next week. Otherwise it's a no.\" [The Half Yes]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You want to say no now without relitigating every past yes.", a: "\"I know I usually do. Not this time.\" [Understand First]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You could do it but it would be inconvenient.", a: "\"I can do it. It'll be Thursday rather than tomorrow.\" [The Half Yes]", bundle: 'pro' },
        { q: "It genuinely is yours to decline and you are sure.", a: "\"I've thought about it and it's a no.\" [Say No Simply]", bundle: 'pro' },
        { q: "They have covered for you twice this year.", a: "\"You've picked me up twice. This one's mine.\" [Understand First]", bundle: 'pro' },
  ...
  setupquestion: [
    {
      ...
      inputs: [
        { q: "You have asked three questions and answered none of them.", a: "\"I've been interrogating you. Mine's the same, for what it's worth — I signed up to get better at this.\" [Purpose Question]", bundle: 'pro' },
        { q: "Their answers are getting shorter with each question.", a: "\"I'll stop asking and give you something. I'm halfway through moving flat and it's chaos.\" [Action Question]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You asked how they were and got \"fine, thanks\" and a pause.", a: "\"I'll go first, then — I'm shattered and mildly grumpy. How's your week actually been?\" [Status Question]", bundle: 'pro' },
        { q: "The real question got the ritual answer.", a: "\"Fair enough. I'm running on four hours' sleep, which explains most things about me today.\" [Status Question]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You asked what is new and got \"not much\".", a: "\"Fair. Are you watching anything at the moment? I've started something terrible and I can't stop.\" [Action Question]", bundle: 'pro' },
        { q: "They cannot think of anything to say they have been doing.", a: "\"Mine's small too — I repainted a wardrobe badly. Have you got anything on the go?\" [Action Question]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You asked the whole table and nobody answered.", a: "\"I'll start, then — I came because a friend dragged me. How about you two?\" [Purpose Question]", bundle: 'pro' },
        { q: "The question landed in the middle of a group and died.", a: "\"Let me aim that better. Sara, how do you know everyone here?\" [Background Question]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You both answered and then it went quiet.", a: "\"You said you'd come straight from work — what is it you do?\" [Action Question]", bundle: 'pro' },
        { q: "You are scanning for a fresh question type.", a: "\"Go back a bit — you said you nearly didn't come. Why nearly?\" [Purpose Question]", bundle: 'pro' },
  ...
  givingcounterexamples: [
    {
      ...
      inputs: [
        { q: "You said \"actually, that's not true\" and they went defensive.", a: "\"That came out wrong. You're right in general — I only meant it isn't universal.\" [The Smaller Claim]", bundle: 'pro' },
        { q: "They are now arguing for the claim harder than they believe it.", a: "\"I'm not arguing against you. Most of the time it's exactly as you said.\" [The Smaller Claim]", bundle: 'pro' },
        { q: "The exchange has become about who is right.", a: "\"I've made this bigger than it was. My point was only about the edge case.\" [The Smaller Claim]", bundle: 'pro' },
        { q: "They repeat the claim more firmly than before.", a: "\"That's on me — I led with the objection instead of the agreement. You're right about most cases.\" [The Smaller Claim]", bundle: 'pro' },
        { q: "You can hear that your tone did the damage rather than the words.", a: "\"Let me say that again properly. Usually it works exactly as you said. I ran into one week where it didn't.\" [Your Own Exception]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "They said \"that's just one person\" and it is a fair hit.", a: "\"It is one. One's enough to make it 'usually' rather than 'always', though.\" [The Smaller Claim]", bundle: 'pro' },
        ...
        { q: "You said \"so it's not true\" and meant \"so it's not always true\".", a: "\"Wrong word from me. Not always — that's all I meant.\" [The Smaller Claim]", bundle: 'pro' },
        { q: "They ask how many exceptions you actually know of.", a: "\"One I've lived and one I've watched. Not enough for a rule, enough to lose the 'always'.\" [The Smaller Claim]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You named a colleague they have never met.", a: "\"Bad example — you don't know him. Everyone knows one person who revises nothing and does fine.\" [Seen It Happen]", bundle: 'pro' },
        { q: "The example needed setting up and lost the room.", a: "\"Let me use an easier one. Plenty of famous books were rejected a dozen times.\" [The Known Exception]", bundle: 'pro' },
        { q: "They nodded politely and the point did not land.", a: "\"That one's too far from here. Think of the recall last year — three days, whole product.\" [The Known Exception]", bundle: 'pro' },
        { q: "You had to explain who the person in your example was.", a: "\"If I have to introduce him, he's the wrong example. Everyone knows one person who does the opposite.\" [Seen It Happen]", bundle: 'pro' },
        { q: "The reference turned out not to be shared at all.", a: "\"Forget that one. Simpler version: plenty of famous books were turned down a dozen times.\" [The Known Exception]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "The claim is clearly aimed at someone sitting there.", a: "\"Let's take it off people. Say someone works nights — does the rule still hold?\" [Where It Would Break]", bundle: 'pro' },
        ...
        { q: "The generalisation has landed on someone in the room.", a: "\"Nobody here, then — think of the vaccine timeline. Everyone said years.\" [The Known Exception]", bundle: 'pro' },
  ...
  discussing: [
    ...
    },
    {
      ...
      inputs: [
        { q: "They keep saying \"that's not what I mean\".", a: "\"Then I've got the wrong end. What DO you mean by it, in one sentence?\" [Ask What They Mean]", bundle: 'pro' },
        { q: "The disagreement feels bigger than the topic warrants.", a: "\"I think we mean different things by 'broken'. Which part is broken for you?\" [Ask What They Mean]", bundle: 'pro' },
        { q: "A key word is carrying too much weight.", a: "\"Give me a case where that happened. I'll follow it much better with an example.\" [Ask What They Mean]", bundle: 'pro' },
        { q: "You realise you have been arguing against a position they never took.", a: "\"I've been arguing with something you didn't say. Sorry — start again?\" [Play It Back]", bundle: 'pro' },
        { q: "You suspect you actually agree.", a: "\"I think we might be saying the same thing in different words. Test it on me?\" [Play It Back]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You have been talking for four minutes.", a: "\"I've had a good run at that. Let me say your side back before I go further.\" [Play It Back]", bundle: 'pro' },
        { q: "You have said almost nothing and are starting to resent it.", a: "\"I've not said anything and I should have — my reason for doubting is the handover.\" [The Reasoning]", bundle: 'pro' },
        { q: "The quietest person in the group has said one sentence.", a: "\"Sara, you said it was tight — tight how?\" [Ask What They Mean]", bundle: 'pro' },
        { q: "Someone keeps talking over the same person.", a: "\"Hang on — she wasn't finished. Go on.\" [Let Them Finish]", bundle: 'pro' },
        { q: "You keep starting to speak and being cut off.", a: "\"Third time I've tried to say this. Can we slow down a bit?\" [Keep the Temperature Down]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "They have convinced you and you are still arguing.", a: "\"I'm defending something I don't think any more. My view now is yours — the shift cover settles it.\" [Your Own View]", bundle: 'pro' },
        { q: "You are hunting for a small point to be right about.", a: "\"I'm picking at details. My actual view is that you're right about this one.\" [Your Own View]", bundle: 'pro' },
        { q: "Only half of their case moved you.", a: "\"You've answered the cost. My reason on the timing still stands — two people are off.\" [The Reasoning]", bundle: 'pro' },
        { q: "Conceding feels like losing in front of others.", a: "\"For the record, I've come round. That's my view now.\" [Your Own View]", bundle: 'pro' },
        { q: "You want to concede but only quietly.", a: "\"Let me say it back: the night shift is the bit that makes it work. Yes — I'm with you.\" [Play It Back]", bundle: 'pro' },
  ...
  talkingaboutyourself: [
    {
      ...
      inputs: [
        { q: "Someone asks what you did at the weekend and you did nothing.", a: "\"Nothing at all, on purpose. It was excellent.\" [True, Not Impressive]", bundle: 'pro' },
        { q: "You are hunting for something worth reporting.", a: "\"Terrible television and too much coffee, honestly.\" [True, Not Impressive]", bundle: 'pro' },
        ...
        { q: "You are about to inflate a story to make it land.", a: "\"It's a much duller story than I was about to make it. I went, it rained, I left.\" [True, Not Impressive]", bundle: 'pro' },
        ...
        { q: "Your week genuinely was the same as every other week.", a: "\"Identical to last week. I've started to find that quite restful.\" [True, Not Impressive]", bundle: 'pro' },
        { q: "Someone with an eventful life has just told you about theirs.", a: "\"Nothing like that here. My news is a new kettle.\" [True, Not Impressive]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "A friend tells you something serious about their health.", a: "\"That's a lot. I'm not going to match that with a work story — tell me more.\" [Match Their Depth]", bundle: 'pro' },
        { q: "You have something comparable and it would genuinely help.", a: "\"I'll match you, since it might help: I went through the same thing in 2019.\" [Match Their Depth]", bundle: 'pro' },
        { q: "You are about to change the subject because it is uncomfortable.", a: "\"I nearly moved us on then. I'd rather stay with what you said.\" [Match Their Depth]", bundle: 'pro' },
        ...
        { q: "You have nothing comparable at all and feel you should.", a: "\"I've got nothing that compares, and I don't think you need me to.\" [Match Their Depth]", bundle: 'pro' },
        { q: "They played it down and you can tell it is not small.", a: "\"You said that very lightly for something that size.\" [Match Their Depth]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "Someone asks what you do.", a: "\"I teach English. Mostly to teenagers, which is as loud as it sounds.\" [Behind the Question]", bundle: 'pro' },
        { q: "You gave the title and the conversation stalled.", a: "\"That's the title. What I actually do all day is answer email.\" [Behind the Question]", bundle: 'pro' },
        { q: "You do not much like your job and would rather not lead with it.", a: "\"I work in logistics, which I'd rather not describe. Ask me about weekends.\" [Behind the Question]", bundle: 'pro' },
        { q: "There is a part of the job you genuinely like.", a: "\"Technically accounting. The bit I like is the detective work.\" [What You're Into]", bundle: 'pro' },
        ...
        { q: "Your job needs three sentences to explain properly.", a: "\"It takes a while to describe. Short version: I stop two systems arguing.\" [Behind the Question]", bundle: 'pro' },
        { q: "You are between jobs and the question comes anyway.", a: "\"Nothing, at the moment, and it's been more interesting than I expected.\" [True, Not Impressive]", bundle: 'pro' },
        { q: "You are about to say \"just\" in front of your job title.", a: "\"Admin. Which sounds small and runs the entire building.\" [Behind the Question]", bundle: 'pro' },
      ]
    },
    {
      name: "A Bad Stretch",
      ...
      inputs: [
        { q: "A colleague asks how you are as they pass your desk.", a: "\"Bit of a rough week, honestly. Nothing that won't keep.\" [True, Not Impressive]", bundle: 'pro' },
        { q: "A friend has stopped and is actually waiting for the real answer.", a: "\"Honestly? Not my best month. Nothing dramatic, just heavy.\" [Match Their Depth]", bundle: 'pro' },
        { q: "You are about to say \"fine\" for the twentieth time.", a: "\"I've been saying fine for two months and it isn't true.\" [True, Not Impressive]", bundle: 'pro' },
        ...
        { q: "They can obviously tell and are giving you the chance to say so.", a: "\"You've clearly noticed. Yes — it's been a hard couple of months.\" [True, Not Impressive]", bundle: 'pro' },
        { q: "You want to answer honestly without making it their problem.", a: "\"Not brilliant, but I'm handling it. Genuinely nothing you need to do.\" [Match Their Depth]", bundle: 'pro' },
  ...
  startingconversations1: [
    {
      ...
      inputs: [
        ...
        { q: "They are clearly working but you have just joined the team.", a: "\"I'll not interrupt — I started today. I'm... I'll catch you later.\" [Introduce Yourself]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You will be sat in this quiet room together for an hour.", a: "\"Looks like it's just us. I'm...\" [Introduce Yourself]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "Three people are talking and you know none of them.", a: "\"Mind if I join? I don't know anybody here. I'm...\" [Introduce Yourself]", bundle: 'pro' },
        { q: "You catch the eye of one person on the edge of a group.", a: "\"Hi — I'm...\" [Introduce Yourself]", bundle: 'pro' },
        ...
        { q: "A group is forming for an activity and you are not in one.", a: "\"Have you got room for one more? I'm...\" [Introduce Yourself]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You have sat beside this person for half of a long day.", a: "\"I've been sitting next to you all morning and never said hello. I'm...\" [Introduce Yourself]", bundle: 'pro' },
        { q: "You have passed the same neighbour weekly for a year.", a: "\"We must have passed each other fifty times, and I'm on the third floor. I'm...\" [Introduce Yourself]", bundle: 'pro' },
        ...
        { q: "You have been in the same club for a term without learning anyone's name.", a: "\"I've been coming since September and I know nobody. I'm...\" [Introduce Yourself]", bundle: 'pro' },
        { q: "You realise mid-journey that you should have spoken an hour ago.", a: "\"Long one, this.\" [Comment on the Situation]", bundle: 'pro' },
        { q: "You are about to leave a two-day course having said nothing to your neighbour.", a: "\"Two days and I never introduced myself. I'm...\" [Introduce Yourself]", bundle: 'pro' },
      ]
    },
    {
      name: "A Flat Reply",
      ...
      inputs: [
        ...
        { q: "Your opener landed but they seem to be leaving.", a: "\"Before you go — I'm... I'll probably see you next week.\" [Introduce Yourself]", bundle: 'pro' },
  ...
  startingconversations2: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "You start to give advice about their life rather than the situation.", a: "\"None of my business, though. How's it going otherwise?\" [The Shared Thread]", bundle: 'pro' },
        ...
        { q: "They took the tip and clearly want the conversation over.", a: "\"Good to see you anyway. I'll let you get on.\" [The Shared Thread]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You know something was going on but not what.", a: "\"You told me something last time and I've completely lost it. What was happening?\" [The Shared Thread]", bundle: 'pro' },
        { q: "You remember the topic but not the outcome.", a: "\"Did the house thing ever get sorted? I've lost track of where you got to.\" [The Shared Thread]", bundle: 'pro' },
        { q: "You are about to guess and might guess wrong.", a: "\"Refresh me — was it the interview or the move that was happening?\" [The Shared Thread]", bundle: 'pro' },
        ...
        { q: "You realise mid-sentence you have mixed them up with someone else.", a: "\"That's someone else entirely, isn't it. Sorry. What have you been up to?\" [The Shared Thread]", bundle: 'pro' },
        { q: "You remember their face and nothing else.", a: "\"We've met — I'm terrible with this. Remind me where?\" [Ask for Help]", bundle: 'pro' },
        { q: "You remember the detail but not whether they told you or someone else.", a: "\"Someone told me about the allotment and I think it was you. Was it?\" [The Shared Thread]", bundle: 'pro' },
        { q: "The last conversation was months ago and could have gone anywhere.", a: "\"It's been ages. What's changed since?\" [The Shared Thread]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "Someone was waiting on medical results.", a: "\"How have you been? You had things going on last time we spoke.\" [The Shared Thread]", bundle: 'pro' },
        { q: "You know they were at risk of losing a job.", a: "\"How did things land at work in the end? Only if you want to.\" [The Shared Thread]", bundle: 'pro' },
        { q: "They gave a very short answer and you were going to ask more.", a: "\"Fair enough. Are you around for the rest of the week?\" [The Shared Thread]", bundle: 'pro' },
        ...
        { q: "They said it did not go well and you do not know what to say.", a: "\"That's rough. Do you want to talk about it or would you rather not?\" [The Shared Thread]", bundle: 'pro' },
        { q: "You want to open the door without pushing it.", a: "\"How are things? Say 'fine' if that's easier.\" [The Shared Thread]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { q: "They clearly do not want to talk about it.", a: "\"Say no more. Are you off after this?\" [The Shared Thread]", bundle: 'pro' },
  ...
  showunderstanding: [
    {
      ...
      inputs: [
        { q: "You can feel \"have you tried\" forming.", a: "\"So it's the whole process that's the problem, not one bit of it.\" [Loop Back]", bundle: 'pro' },
        { q: "The solution seems obvious to you and they have not mentioned it.", a: "\"What have you already tried with it?\" [Follow-up Question]", bundle: 'pro' },
        { q: "You are impatient to get to the practical part.", a: "\"What's the bit that's actually wearing you down?\" [Follow-up Question]", bundle: 'pro' },
        { q: "They describe a problem you have solved before.", a: "\"That sounds genuinely exhausting to keep managing.\" [Loop Back]", bundle: 'pro' },
        { q: "You have already given advice and they are still describing it.", a: "\"Sorry — I jumped ahead. Tell me the rest of it.\" [Follow-up Question]", bundle: 'pro' },
        { q: "They ask \"what would you do?\" and you are not sure they mean it.", a: "\"I'll say — but first, what's putting you off the obvious one?\" [Follow-up Question]", bundle: 'pro' },
        ...
        { q: "You gave advice, it was ignored, and they are back with the same thing.", a: "\"So it's still going, and nothing's shifted it.\" [Loop Back]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "You are three sentences into your own version.", a: "\"Anyway — yours sounds worse. What happened with the deadline?\" [Loop Back]", bundle: 'pro' },
        { q: "You notice they have started asking you questions.", a: "\"We're talking about me now, sorry. Go back to the group thing.\" [Loop Back]", bundle: 'pro' },
        ...
        { q: "You are about to add a second example of your own.", a: "\"Same feeling, anyway. What did you end up doing?\" [Follow-up Question]", bundle: 'pro' },
        ...
        { q: "Someone else joins and asks you about the thing you just mentioned.", a: "\"Later — she was telling me about the group project.\" [Loop Back]", bundle: 'pro' },
        { q: "You realise you have not asked them anything for five minutes.", a: "\"I've talked all over that. What happened in the end?\" [Follow-up Question]", bundle: 'pro' },
        { q: "They politely wait for your story to finish.", a: "\"That's enough from me. Back to yours.\" [Loop Back]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "You have said \"so what I'm hearing is\" twice already.", a: "\"So the deadline moved and nobody told you. That's rubbish.\" [Loop Back]", bundle: 'pro' },
        { q: "You repeated their exact words back and it sounded odd.", a: "\"What did you do when you found out?\" [Follow-up Question]", bundle: 'pro' },
        { q: "You can hear yourself using a therapist voice.", a: "\"Right, so it's the being left out that's the actual problem.\" [Loop Back]", bundle: 'pro' },
        ...
        { q: "You are following the formula and not really listening.", a: "\"Say that last bit again? I want to make sure I've got it.\" [Follow-up Question]", bundle: 'pro' },
        { q: "You have started every response with the same three words.", a: "\"That's a mess, then. Who was supposed to tell you?\" [Follow-up Question]", bundle: 'pro' },
        ...
        { q: "You are about to summarise something that took one sentence.", a: "\"What happened next?\" [Follow-up Question]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "There are three names in the story and you cannot place any of them.", a: "\"Sorry — who's Anna in this?\" [Follow-up Question]", bundle: 'pro' },
        { q: "You have lost the order of what happened.", a: "\"Let me check I've got it — the plan changed twice and you found out last?\" [Loop Back]", bundle: 'pro' },
        { q: "You understand the events but not why it upset them.", a: "\"What was the part that got to you most?\" [Follow-up Question]", bundle: 'pro' },
        { q: "You have been nodding along for a minute without following.", a: "\"Can you take me back a step? I've lost the thread.\" [Follow-up Question]", bundle: 'pro' },
        { q: "You are about to loop back something you are not sure of.", a: "\"Tell me if this is wrong — it's the not being asked that's the issue?\" [Loop Back]", bundle: 'pro' },
        { q: "They are using words from their job that you do not know.", a: "\"What's a handover, in your world?\" [Follow-up Question]", bundle: 'pro' },
        { q: "You followed all of it except the ending.", a: "\"So it's resolved — or it isn't, and that's the problem?\" [Loop Back]", bundle: 'pro' },
        { q: "You realise you have been thinking about something else.", a: "\"I drifted for a second, sorry. Start again from the meeting.\" [Follow-up Question]", bundle: 'pro' },
      ]
    },
    {
      name: "Closed Doors",
      ...
      inputs: [
        { q: "They say: \"It's fine, honestly.\" and clearly mean the opposite.", a: "\"It sounds less fine and more relentless, from where I'm sitting.\" [Loop Back]", bundle: 'pro' },
        { q: "They shrug and change the subject.", a: "\"Fair enough. I'm around if it turns into something you want to say.\" [Loop Back]", bundle: 'pro' },
        { q: "They say: \"I don't really want to go into it.\"", a: "\"That's completely fine. No need.\" [Loop Back]", bundle: 'pro' },
        ...
        { q: "Their face says a lot more than their three words did.", a: "\"You don't have to say anything. It just looks like a lot.\" [Loop Back]", bundle: 'pro' },
        { q: "They give one-word answers to everything you ask.", a: "\"I'll stop asking. It's just good to see you.\" [Loop Back]", bundle: 'pro' },
        { q: "They mention it once and immediately move on.", a: "\"You said the thing with your brother — is that still going on?\" [Follow-up Question]", bundle: 'pro' },
  ...
  exploringatopic: [
    {
      ...
      inputs: [
        { q: "The group has covered everything about their holidays.", a: "\"Does anyone actually enjoy the travelling part, or just the arriving?\" [Expand to a Subtopic]", bundle: 'pro' },
        { q: "The conversation about the album has nothing left in it.", a: "\"Are they any good live? I have never seen them.\" [Expand to a Subtopic]", bundle: 'pro' },
        ...
        { q: "The talk about running has covered routes, shoes and races.", a: "\"Does anyone do anything else — swimming, cycling?\" [Expand to a Subtopic]", bundle: 'pro' },
        ...
        { q: "Answers have shortened to three words each.", a: "\"What is the part of it people usually get wrong?\" [Ask an Open Question]", bundle: 'pro' },
        { q: "You can feel the pause coming and there is one detail left.", a: "\"You mentioned the second year was different — what changed?\" [Build on Their Point]", bundle: 'pro' },
        { q: "The subject is done but the group is not ready to move.", a: "\"Mine is a smaller version of that, and it went about as well.\" [Share a Related Experience]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "They use a word you do not know and carry on.", a: "\"Sorry — what is a peloton, in this context?\" [Build on Their Point]", bundle: 'pro' },
        { q: "You have been quiet so long that speaking feels awkward.", a: "\"I have followed none of this, and I would like to. Start me at the beginning?\" [Ask an Open Question]", bundle: 'pro' },
        { q: "There is one corner of the subject you do know something about.", a: "\"The only bit I know is the food. That part I can talk about for hours.\" [Share a Related Experience]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        ...
        { q: "The quiet one clearly knows more about this than anyone.", a: "\"You actually do this for a living — am I getting it wrong?\" [Ask an Open Question]", bundle: 'pro' },
        { q: "A new person is at the table and nobody has drawn them in.", a: "\"We have been at this ten minutes. What do you make of it all?\" [Share, Then Invite]", bundle: 'pro' },
        { q: "Somebody gave a short answer and the group moved straight on.", a: "\"Go back a second — you said it was the timing?\" [Build on Their Point]", bundle: 'pro' },
      ]
    },
    {
      name: "Drift",
      ...
      inputs: [
        { q: "The gardening talk has turned into a discussion about tax.", a: "\"Before we get lost — did anyone else's tomatoes fail this year?\" [Expand to a Subtopic]", bundle: 'pro' },
        ...
        { q: "The music conversation drifted into phone contracts.", a: "\"That reminds me — does anyone still buy actual records?\" [Expand to a Subtopic]", bundle: 'pro' },
        ...
        { q: "Your own answer is what took it off course.", a: "\"That was me wandering off. You were mid-story.\" [Build on Their Point]", bundle: 'pro' },
        { q: "The new subject is fine but the old one was better.", a: "\"We can come back to this — did you ever finish the kitchen?\" [Build on Their Point]", bundle: 'pro' },
        { q: "The drift happened because the old topic was running out.", a: "\"Fair enough, that one was done. What else has everyone been up to this month?\" [Ask an Open Question]", bundle: 'pro' },
      ]
    },
    {
      name: "Taking Over",
      ...
      inputs: [
        ...
        { q: "Somebody tried to speak while you were mid-sentence.", a: "\"You went to say something — go on.\" [Ask an Open Question]", bundle: 'pro' },
        { q: "You know a lot about this and it keeps coming out.", a: "\"I could do this all night, which is exactly why I should stop. Who else?\" [Share, Then Invite]", bundle: 'pro' },
        { q: "You have been asked a question and the answer is long.", a: "\"Short version, then somebody stop me: it took two years and most of a summer.\" [Share a Related Experience]", bundle: 'pro' },
      ]
    },
  ],
  changingtopics: [
    {
      ...
      inputs: [
        { q: "You've tried to move on twice and they keep pulling it back.", a: "\"I think we've really covered this one — genuinely, what else is going on with you?\" [Respectful Exit]", bundle: 'pro' },
        ...
        { q: "It's only the second lap and you'd rather be gentle about it.", a: "\"Still no fun, that. Anyway — did you get anywhere with the flat?\" [Acknowledge and Redirect]", bundle: 'pro' },
        { q: "They circle back to it every time you open something else.", a: "\"You clearly need to say more about it. Say it properly, then let's leave it.\" [Respectful Exit]", bundle: 'pro' },
        { q: "The loop is a happy one — a story they love telling.", a: "\"I love that one. What's the newest thing you've got?\" [Respectful Exit]", bundle: 'pro' },
        { q: "A group has gone round the same subject three times.", a: "\"We could do this all night, couldn't we. Someone give us a new one.\" [Respectful Exit]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "A sensitive topic comes up that you can't just joke your way out of.", a: "\"That's a heavy one, and I don't want to make light of it. How have things been otherwise?\" [Steer Away]", bundle: 'pro' },
        { q: "Someone overshared and it's gone quiet and awkward.", a: "\"No judgement here at all — and hey, how's the new job been?\" [Steer Away]", bundle: 'pro' },
        { q: "A group starts arguing and it's getting tense.", a: "\"We all feel strongly on that one. Anyway — anyone been anywhere nice lately?\" [Steer Away]", bundle: 'pro' },
        ...
        { q: "Someone asks you directly to take a side in it.", a: "\"I'm going to be useless on that one, honestly. How's your end of things?\" [Steer Away]", bundle: 'pro' },
        { q: "The subject is painful for someone who is in the room.", a: "\"I think that's theirs to talk about, if they want. What else has been happening?\" [Steer Away]", bundle: 'pro' },
        { q: "They clearly want to leave it but can't find the way out.", a: "\"Shall we park that? Tell me about the weekend instead.\" [Respectful Exit]", bundle: 'pro' },
        { q: "They said something raw and then made a joke about it.", a: "\"I'll take the joke, but the offer's there another time. How's everything else?\" [Steer Away]", bundle: 'pro' },
      ]
    },
    {
      name: "The Stall",
      ...
      inputs: [
        { q: "There's no natural detail to bridge from — they've said almost nothing.", a: "\"Totally out of nowhere, but — what's been the highlight of your week?\" [The Random Switch]", bundle: 'pro' },
        { q: "Small talk has died into silence.", a: "\"Right, random question to save us — best thing you've eaten this week?\" [The Random Switch]", bundle: 'pro' },
        { q: "The conversation keeps fizzling after every topic.", a: "\"Let me try a fun one — if you could teleport anywhere right now, where?\" [The Random Switch]", bundle: 'pro' },
        { q: "You're both out of easy things to say.", a: "\"I've got a curveball — worst film you've ever paid to see?\" [The Random Switch]", bundle: 'pro' },
        { q: "They gave you three words and the silence came back.", a: "\"Same energy here, honestly. It's been a long week.\" [Common Ground]", bundle: 'pro' },
        { q: "You are stuck together for a while and it has gone quiet twice.", a: "\"We're going to be here a bit, so I'll ask something daft — tea or coffee, and why are you wrong?\" [The Random Switch]", bundle: 'pro' },
        { q: "The silence has lasted long enough that you're both aware of it.", a: "\"I've got nothing, and I refuse to be beaten. What did you do at the weekend?\" [The Random Switch]", bundle: 'pro' },
        { q: "They finally offer one small detail.", a: "\"You said Gothenburg — what took you up there?\" [The Bridge]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "Your light switch got ignored and the heavy topic rolls on.", a: "\"I'll be honest — I'd love to lift the mood a bit. What's something good that's happened lately?\" [The Random Switch]", bundle: 'pro' },
        ...
        { q: "Your redirect got a one-word reply and then back to the old subject.", a: "\"Okay, new tack entirely — got any plans this weekend?\" [The Random Switch]", bundle: 'pro' },
        { q: "They keep answering your new topic with the old one.", a: "\"You're clearly not finished with it. Go on, then — say the rest.\" [Acknowledge and Redirect]", bundle: 'pro' },
        { q: "The group followed you but one person did not.", a: "\"We'll come back to it. Anna was mid-sentence about something.\" [Respectful Exit]", bundle: 'pro' },
        { q: "You switched, they switched back, and you both noticed.", a: "\"Ha — we're pulling in opposite directions. Yours or mine?\" [The Random Switch]", bundle: 'pro' },
        { q: "They ignored the switch because they had not finished.", a: "\"Fair enough, finish it properly. I jumped in too early.\" [Acknowledge and Redirect]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "You brought something up and got polite nods and nothing else.", a: "\"Right, nobody cares about that — fair. What's everyone actually been doing?\" [The Random Switch]", bundle: 'pro' },
        { q: "Your story finished and the silence sat there.", a: "\"Anyway. That was a lot of words about a shed. What have you got?\" [The Random Switch]", bundle: 'pro' },
        { q: "You asked a question and got one-word answers from everyone.", a: "\"Bad question. Let me try again — worst journey any of you has had this year?\" [The Random Switch]", bundle: 'pro' },
        { q: "You raised something and realised mid-sentence it was the wrong room.", a: "\"I'm going to leave that one there, actually. How was the weekend?\" [Respectful Exit]", bundle: 'pro' },
        { q: "You want to move on without making a thing of it.", a: "\"Anyway — you were saying something about the new place?\" [The Bridge]", bundle: 'pro' },
        ...
        { q: "Your joke landed flat and the room went quiet.", a: "\"That was for me, clearly. Moving swiftly on — anyone got weekend plans?\" [The Random Switch]", bundle: 'pro' },
        { q: "You realise you have started three subjects that all died.", a: "\"I'm three for three on bad topics. Someone else drive.\" [The Random Switch]", bundle: 'pro' },
      ]
    },
  ],
  complimenting: [
    {
      ...
      inputs: [
        { q: "They say \"oh, it was nothing\".", a: "\"It wasn't. The ending specifically — you didn't oversell it.\" [The Specific Thing]", bundle: 'pro' },
        { q: "They put it down to luck.", a: "\"You chose to cut the first version. That's not luck.\" [Choice, Not Luck]", bundle: 'pro' },
        { q: "They cannot argue with what it did to you.", a: "\"Whether it was good or not, I've started doing it your way.\" [Why It Landed]", bundle: 'pro' },
        { q: "You have now said it twice and they still will not take it.", a: "\"You never take these. I'm going to keep saying them anyway.\" [Hold Yours Back]", bundle: 'pro' },
        { q: "They deflect by complimenting you back immediately.", a: "\"Nice try. This one's about you.\" [Hold Yours Back]", bundle: 'pro' },
        { q: "They credit the whole team instead of themselves.", a: "\"The team was there. You're the one who made the call.\" [Choice, Not Luck]", bundle: 'pro' },
        { q: "They laugh and change the subject.", a: "\"You can move on, I'm just leaving it on the table.\" [Who They Are]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You manage them and want to praise the work.", a: "\"The order you put the sections in is what made it work.\" [The Specific Thing]", bundle: 'pro' },
        { q: "You manage them and want the room to know.", a: "\"The whole second half is Jonas's work.\" [Where It Counts]", bundle: 'pro' },
        { q: "You want to praise your manager without it sounding like flattery.", a: "\"When you took the blame for that in the meeting, it changed how I saw the team.\" [Why It Landed]", bundle: 'pro' },
        { q: "The character compliment would sound like an appraisal.", a: "\"I'll say this at your desk rather than in the room: you're the steady one here.\" [Where It Counts]", bundle: 'pro' },
        { q: "Someone senior praises you in front of the team.", a: "\"Thank you — that's a nice thing to hear in front of people.\" [Hold Yours Back]", bundle: 'pro' },
        { q: "You are praising a peer while your manager is listening.", a: "\"For the record, the difficult half was hers.\" [Where It Counts]", bundle: 'pro' },
        { q: "Praise from you might be heard as the start of a request.", a: "\"Nothing attached to this — the report was the clearest one this year.\" [The Specific Thing]", bundle: 'pro' },
        { q: "You are new and everyone senior is in the room.", a: "\"I'm new, so take it as an outside view: you run the shortest meetings I've sat in.\" [Who They Are]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "You like what a colleague is wearing.", a: "\"Good jacket. That's all, carry on.\" [Where It Counts]", bundle: 'pro' },
        { q: "You are about to compliment their face or their body.", a: "\"Whoever cuts your hair knows what they're doing.\" [Choice, Not Luck]", bundle: 'pro' },
        { q: "A friend has clearly made an effort tonight.", a: "\"You've put that together properly. It's very you.\" [The Specific Thing]", bundle: 'pro' },
        { q: "They wave it off as an old thing they threw on.", a: "\"You still chose it. That counts.\" [Choice, Not Luck]", bundle: 'pro' },
        ...
        { q: "You are in a group and the compliment is personal.", a: "\"I'll tell you afterwards rather than in front of everyone.\" [Where It Counts]", bundle: 'pro' },
        { q: "They have obviously changed something and you are not sure what.", a: "\"Something's different and it's working. I can't tell you what it is.\" [The Specific Thing]", bundle: 'pro' },
        { q: "Someone serving you cannot easily leave the conversation.", a: "\"That's a great pair of glasses.\" (and then let them get on) [Choice, Not Luck]", bundle: 'pro' },
      ]
    },
    {
      ...
      inputs: [
        { q: "You never say things like this to your family.", a: "\"We don't say this sort of thing. I'm going to anyway.\" [Who They Are]", bundle: 'pro' },
        { q: "It is years overdue and that is the awkward part.", a: "\"I should have said this a long time ago, and here it is anyway.\" [Who They Are]", bundle: 'pro' },
        { q: "You want to anchor it in something real.", a: "\"You drove two hours for someone who wouldn't have done it for you.\" [Who They Are]", bundle: 'pro' },
        { q: "They did something good years ago that you never acknowledged.", a: "\"I never said it at the time: what you did that summer mattered.\" [Why It Landed]", bundle: 'pro' },
        { q: "You have said it and they have gone quiet.", a: "(let it sit — do not fill the pause) [Who They Are]", bundle: 'pro' },
        { q: "Saying it face to face is more than you can manage.", a: "\"I'm writing this because I'd fumble it out loud.\" [Where It Counts]", bundle: 'pro' },
        { q: "They deflect with a joke, the way they always do.", a: "\"You can joke. It's still true and I've still said it.\" [Hold Yours Back]", bundle: 'pro' },
    ...
    },
    {
      ...
      inputs: [
        { q: "You are about to praise them and then ask for a favour.", a: "\"I need a favour — that's the whole message, no warm-up.\" [Where It Counts]", bundle: 'pro' },
        { q: "You are about to open a criticism with something nice.", a: "\"This is a criticism and I'm not going to wrap it: the second half doesn't work.\" [Why It Landed]", bundle: 'pro' },
        { q: "You want to say something warm to soften bad news.", a: "\"The news first: we're not going ahead. I'll say the rest when it isn't padding.\" [Who They Are]", bundle: 'pro' },
        { q: "You do not actually believe the compliment you are about to give.", a: "(leave it — if you noticed nothing there is nothing to name) [The Specific Thing]", bundle: 'pro' },
        { q: "There is something you genuinely admire and no agenda at all.", a: "\"No reason for saying this: you're very good at what you do.\" [Who They Are]", bundle: 'pro' },
        { q: "You praised them last week and now you need something.", a: "\"Separate from last week, and this one is just a request.\" [Where It Counts]", bundle: 'pro' },
        { q: "Someone praises you and you can hear the request coming.", a: "\"Thank you. What's the ask?\" [Take a Compliment]", bundle: 'pro' },
        { q: "The compliment is really about how it makes you look to say it.", a: "\"I'll say this to you, not to the room.\" [Where It Counts]", bundle: 'pro' },
      ]
    },
  ],
  responsivehumour: [
